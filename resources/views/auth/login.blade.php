...
<div class="login">
    <div class="content_login">
        ...
        <div class="login-link-div">
            <a href="{{ route('usuario_cliente.registrar') }}" class='login-link'>Cliente, cadastre-se aqui</a>
        </div>
        <hr>
        <div class="login-link-div">
            <a href="{{ route('usuario_cliente.resetar') }}" class='login-link'>Sou cliente/representante e esqueci minha senha</a>
        </div>
    </div>
</div>
@endsection
