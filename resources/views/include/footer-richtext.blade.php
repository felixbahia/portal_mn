    ...
    <link  rel="stylesheet" href="{{ asset('includes/richtexteditor/rte_theme_default.css') }}"/>
    <link  rel="stylesheet" href="{{ asset('includes/richtexteditor/runtime/richtexteditor_content.css') }}"/>
   
    <script type="text/javascript" src="{{ asset('includes/richtexteditor/rte.js') }}"></script>
    <script type="text/javascript" src="{{ asset('includes/richtexteditor/plugins/all_plugins.js') }}"></script>
