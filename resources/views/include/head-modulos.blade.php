...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            ...
            <div class="content-modulos">
                <div class="modulo-ativo">
                    <img src="@yield('module-image')" border="0" alt="" />
                    <span>@yield('module-name')</span>
                </div>
    ...
    <div class="content-nav-header">
        <div class="content-modulos">
            ...
            @if (trim($__env->yieldContent('sub-module-name')))
            <div class="modulo">
                <a href="@yield('module-url')">
                    @yield('module-name')
                </a>
            </div>
            <div class="tela">
                @yield('sub-module-name')
            </div>
            @else
            <div class="tela">
                @yield('module-name')
