...
<head>
    ...
    <title>{{ config('app.name', 'MN Tecidos') }}{{ CustomView::titlePage() }}</title>
    ...
    <link href="{{ asset('includes/Roadmap/jquery.roadmap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('includes/bootstrap/css/bootstrap-multiselect.css') }}" rel="stylesheet">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            ...
            <div class="content-modulos">
                <div class="modulo-ativo">
                    <img src="{{ CustomView::modelIcon() }}" border="0" alt="" />
                    <span>{{ CustomView::modelName() }}</span>
                </div>
                <div class="outro-modulo">
                    <a href="{{ route('home') }}">
                        <img src="{{ URL::asset('/images/icons/outros-icon.png') }}" border="0" alt="" />
    ...
    @endif
    <div id="app">
        {!! CustomView::createTitlePage() !!}
        @if (trim($__env->yieldContent('content-filter')))
