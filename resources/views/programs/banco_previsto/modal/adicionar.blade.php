...
@section('content')
<form action="" name="form_banco_previsto" id="form_banco_previsto" onsubmit="return false;">
    @csrf
    <div class="form-row">
    ...
    <div class="form-row">
        <div class="form-group col-sm-12">
            ...
            {!! Form::text('valor', '', ['id' => 'valor', 'class' => 'form-control moeda text-right', 'placeholder' => 'Valor Nacional']) !!}
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        form_modal = $(document).find("#form_banco_previsto");
    ...
    function inserirDados(form_modal){
        ...
        $.ajax({
            url: "{{ route('banco_previsto.adicionar') }}", 
            dataType: 'json',
