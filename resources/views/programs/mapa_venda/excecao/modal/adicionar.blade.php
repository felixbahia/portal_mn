...
<form action="" name="form_mapa_venda_excecao_add" id="form_mapa_venda_excecao_add" onsubmit="return false;">
    ...
    <div class="form-row">
        <div class="form-group col-sm-12"> 
            ...
            {{ Form::text('numero_nota', '', ['id' => 'numero_nota', 'class' => 'form-control', 'placeholder' => 'Nota Fiscal', 'maxlength' => '15']) }}
        </div>
    </div>
    <div class="form-row">
    ...
    <div class="form-row">
        <div class="form-group col-sm-12"> 
            ...
            {{ Form::select('equipe', $unidades_negocios, [], ['id' => 'equipe', 'class' => 'form-control', 'placeholder' => 'Selecione a Equipe']) }}
        </div>
    </div>
...
<script>
    ...
    function inserirDados(form_modal_add){
        ...
        $.ajax({
            url: "{{ route('mapa_venda.excecao.adicionar') }}", 
            dataType: 'json',
            data: {
                _token: "{{ csrf_token() }}",
