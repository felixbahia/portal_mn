	...
	<form action="#" method="post" id="form_adicionar" name="form_adicionar" class="form_adicionar" onsubmit="return false">
		...
		<div class="form-row">
			...
			<div class="form-group col-sm-12">
				...
				{!! Form::select('modulos', $modulos, '', ['id' => 'modulos', 'class' => 'form-control', 'placeholder' => 'Todos']) !!}
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-sm-12">
		...
		<div class="form-row">
			<div class="col-md-12 mt-4">
				{{ Form::button('Salvar', array('id' => 'salvar', 'class' => 'btn btn-primary float-right')) }}
...
<script>
	...
	$(document).ready( function(){
		...
		form_modal_adicionar.find("#salvar").on("click", function(event){
		...
		$.ajax({
			...
			success: function(callback){
				if(callback.status === 'success'){
					...
					$(document).find('#modal_add_video').modal('hide');
					filtro();
