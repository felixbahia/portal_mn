...
<div class="row">
	<div class="col-sm-12">
		<b>Deseja realmente excluir este projeto?</b>
	</div>
</div>
<br>
<div class="row border-bottom">
	<div class='col-sm-6'><b>Projeto</b></div>
	<div class='col-sm-6'>{!! nl2br($dados['projeto']) !!}</div>
</div>
<div class="row border-bottom">
...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$(document).find("#btn-delete").on("click", function(event) {
			var $this = $(this);
			$.ajax({
				url: "{{ route('lancamento_projeto.deletar') }}",
				dataType: 'json',
				...
				success: function(callback){
					if(callback.status === "success"){
						...
						message("Atenção", "Projeto excluido com sucesso!");
					} else {
