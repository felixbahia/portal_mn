...
<div style="max-width: 1200px;margin-left: auto;margin-right: auto;">
    <div class="embed-responsive-item" style="border: 3px solid #000; border-radius: 7px"  id="iframe_contrato" name="iframe_contrato">
        <div style="margin: 10px;">
            ...
            </font></font></font><font face="Calibri, serif"><font size="3" style="font-size: 12pt">estabelecida
            na Rua Almirante Barroso, 851, Brás, São Paulo, SP, CEP  03025-001,
            ...
            <p align="justify" style="margin-bottom: 0cm; border: 1px solid #000000; padding-top: 0cm; padding-bottom: 0.04cm; padding-left: 0.14cm; padding-right: 0.14cm; line-height: 115%">
                <font face="Calibri, serif">
                    <font size="3" style="font-size: 12pt">
                        <u><b>VÊNIA CONJUGAL DO(A) FIADOR(A)</b></u>
                    </font>
                </font>
                <font face="Calibri, serif">
                    <font size="3" style="font-size: 12pt">
                        : <b>{{$dados['nome_venia_conjugal']}}</b>
                    </font>
                </font>
            </p>
            <p align="justify" style="margin-bottom: 0cm; border: 1px solid #000000; padding-top: 0cm; padding-bottom: 0.04cm; padding-left: 0.14cm; padding-right: 0.14cm; line-height: 115%">
                <font face="Calibri, serif">
                    <font size="3" style="font-size: 12pt">
                        <b>CPF</b>: {{$dados['cpf_venia_conjugal']}}
                    </font>
                </font>
            </p>
                    ...
                    <tr>
                        <td width="174" valign="bottom" style="border: 1px solid #000000; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
                            <p align="center" style="margin-top: 0.21cm">
                                <font face="Calibri, serif">
                                    <font size="3" style="font-size: 12pt">
                                        <b>{{$parcela['numero']."/".$dados['quantidade_parcela']}}</b>
                                    </font>
                                </font>
                            </p>
                        </td>
            ...
            Terceira.</i></font></font><font face="Calibri, serif"><font size="3" style="font-size: 12pt">
                </font></font>
            </p>
            <p align="justify" style="margin-bottom: 0cm; line-height: 115%"><br/>
            ...
            O não pagamento de qualquer parcela nas datas avençadas implicará
            em multa de 10% (dez por cento) sobre o valor da parcela, mais juros
            de 1% (um por cento) ao mês.</font></font></font></p>
            <p align="justify" style="margin-bottom: 0cm; border: none; padding: 0cm; line-height: 115%">
            <br/>
            ...
            (art. 412 do Código Civil) de 20% (vinte por cento) sobre o saldo
            devedor,  juros de mora 1% (um por cento) ao mês, calculados pro
            rata die, contados da data do vencimento até a data do pagamento,
            valor este que será corrigido monetariamente pela tabela de
            atualização de débitos judiciais do Tribunal de Justiça de São
            Paulo, valendo o presente instrumento como título executivo para
            todos os efeitos de direito.</font></font></font></p>
            <p align="justify" style="margin-bottom: 0cm; border: none; padding: 0cm; line-height: 115%">
            <br/>
            ...
            em caráter solidário, conjuntos entre si, renunciando expressamente
            aos benefícios de ordem, divisão e liquidação, bem assim aos
            favores e exceções dos artigos 827, 835, 838, 1.642, IV  do Código
            Civil Brasileiro, e 794, §§1º, 2º e 3º Código de Processo
            Civil, os fiadores qualificados no preâmbulo do presente
            instrumento, responsabilizando-se autonomamente por todas as
            obrigações derivadas deste contrato, até o efetivo e real
            reembolso da credora em juízo ou fora dele.</font></font></font></p>
            <p align="justify" style="margin-bottom: 0cm; border: none; padding: 0cm; line-height: 115%">
            <br/>
            ...
            Com o cumprimento integral do presente acordo, as partes outorgarão
            a mais plena, rasa, geral, irrevogável e irretratável quitação em
            relação aos termos ora avençados, para nada mais reclamarem, seja
            a que título for.</font></font></p>
            <p align="justify" style="margin-bottom: 0cm; border: none; padding: 0cm; line-height: 115%">
            <br/>
            ...
            Sétima:</b></u></font></font></font><font color="#000000"><font face="Calibri, serif"><font size="3" style="font-size: 12pt">
                O presente instrumento livremente negociado entre as partes poderá
            ser assinado fisicamente, eletronicamente, por e-mail ou assinatura
            digitalizada (aquela resultado da reprodução eletrônica de uma
            assinatura manuscrita do sujeito de direito inserida manualmente em
            um contrato) em caráter irrevogável e irretratável, obrigando as
            partes, seus eventuais herdeiros ou sucessores. </font></font></font>
            </p>
            <p align="justify" style="margin-bottom: 0cm; border: none; padding: 0cm; line-height: 115%">
            <br/>
            ...
            Em caso de necessidade de procedimento judicial com base no presente
            instrumento, a parte culpada arcará com as custas processuais e os
            honorários advocatícios na base de 20% (vinte por cento) sobre o
            valor do débito.</font></font></font></p>
            <p align="justify" style="margin-bottom: 0cm; border: none; padding: 0cm; line-height: 115%">
            <br/>
            ...
            </font></font></font><font face="Calibri, serif"><font size="3" style="font-size: 12pt">Fica
            eleito o Foro da Comarca de São Paulo, SP, para dirimir quaisquer
            dúvidas oriundas do presente instrumento, dispensando-se qualquer
            outro por mais privilegiado que seja.</font></font></p>
            <p align="justify" style="margin-bottom: 0cm; line-height: 115%"><br/>
            
            </p>
            <p align="justify" style="margin-bottom: 0cm; line-height: 115%"><font face="Calibri, serif"><font size="3" style="font-size: 12pt">E
            por ser esta a expressão da verdade, e também a vontade das partes,
            firmam o presente instrumento em 02 (duas) vias de igual teor e
            forma, perante 02 (duas) testemunhas.</font></font></p>
            <p align="justify" style="margin-bottom: 0cm; line-height: 115%"><br/>
            ...
            <center>
                <table width="558" cellpadding="7" cellspacing="0">
                    <col width="251">
                    <col width="17">
                    <col width="248">
                    <tr>
                                ...
                                <tr>
                                    <td width="235" height="15" bgcolor="#f2f2f2" style="background: #f2f2f2" style="border-top: 1px solid #000000; border-bottom: none; border-left: none; border-right: none; padding: 0cm">
                                        <p align="center">
                                            <font face="Calibri, serif">
                                                <font size="3" style="font-size: 12pt">
                                                    <b>CREDORA </br>TÊXTIL MN COMÉRCIO DE TECIDOS E CONFECÇÕES LTDA</b>
                                                </font>
                                            </font>
                                        </p>
                                    </td>
                                    ...
                                    <td width="235" bgcolor="#f2f2f2" style="background: #f2f2f2" style="border-top: 1px solid #000000; border-bottom: none; border-left: none; border-right: none; padding: 0cm">
                                        <p align="center">
                                            <font face="Calibri, serif">
                                                <font size="3" style="font-size: 12pt">
                                                    <b>DEVEDORA </br>{{$dados['cliente_nome']}}</b>
                                                </font>
                                            </font>
                                        </p>
                                    </td>
                                ...
                                <tr>
                                    <td width="241" height="11" bgcolor="#f2f2f2" style="background: #f2f2f2" style="border-top: 1px solid #000000; border-bottom: none; border-left: none; border-right: none; padding: 0cm">
                                        <p align="center" style="margin-left: -0.05cm">
                                            <font face="Calibri, serif">
                                                <font size="3" style="font-size: 12pt">
                                                    <u><b>FIADOR(A)</b></u> </br><b>{{$dados['avalista_nome']}}</b>
                                                </font>
                                            </font>
                                        </p>
                                    </td>
                                    ...
                                    <td width="251" bgcolor="#f2f2f2" style="background: #f2f2f2" style="border-top: 1px solid #000000; border-bottom: none; border-left: none; border-right: none; padding: 0cm">
                                        <p align="center">
                                            <font face="Calibri, serif">
                                                <font size="3" style="font-size: 12pt">
                                                    <u><b>VÊNIA CONJUGAL DO(A) FIADOR(A)</b></u> </br><b>{{$dados['nome_venia_conjugal']}}</b>
                                                </font>
                                            </font>
                                        </p>
                                    </td>
...
<form action="" name="form_aprovacao_cliente" id="form_aprovacao_cliente"  onsubmit="return false;">
    ...
    {!! Form::hidden('tipo', 'aprovacao', ['id' => 'tipo']) !!}
    {!! Form::hidden('estabelecimento_codigo', $estabelecimento_codigo, ['id' => 'estabelecimento_codigo']) !!}
    {!! Form::hidden('cpf_cnpj', $cpf_cnpj, ['id' => 'cpf_cnpj']) !!}
    {!! Form::hidden('venia_conjugal', $dados['venia_conjugal'], ['id' => 'venia_conjugal']) !!}
    ...
    <div class="center_content mt-1" style="position: relative;text-align: center;" id="button-center">
        {{ Form::submit('Gerar PDF', array('class' => 'btn btn-primary', 'id' => 'btn-gerar_pdf')) }}
    </div> 
</form>
@endif
</br>
...
$(document).ready( function () {
    ...
    form_modal.find("#btn-gerar_pdf").off('click');
    form_modal.find("#btn-gerar_pdf").on('click', function(){
        pdfContrato(form_modal);
    });
});

function aceitoContrato(form_modal){
    id = form_modal.find("#id").val();
    id_avalista = form_modal.find("#id_avalista").val();
    tipo = form_modal.find("#tipo").val();
    venia_conjugal = form_modal.find("#venia_conjugal").val();
    $.ajax({
...
function pdfContrato(form_modal){
    id = form_modal.find("#id").val();
    id_avalista = form_modal.find("#id_avalista").val();
    $('<form action="{!! route('renegociacao_titulo.gera_pdf') !!}" method="POST" target="_blank">\
        <input type="hidden" name="_token" value="{!! csrf_token() !!}">\
        <input type="hidden" name="id" value='+id+' />\
        <input type="hidden" name="id_avalista" value='+id_avalista+' />\
