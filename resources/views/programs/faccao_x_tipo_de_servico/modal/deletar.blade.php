...
<div class="row border-bottom">
	<div class='col-sm-6'><b>Facção</b></div>
	<div class='col-sm-6'>{!! nl2br($dados['faccao']) !!}</div>
</div>
<div class="row border-bottom">
...
<div class="row border-bottom">
	<div class='col-sm-6'><b>Unidade</b></div>
	<div class='col-sm-6'>{!! nl2br($dados['unidade']) !!}</div>
</div>
<div class="row border-bottom">
	<div class='col-sm-6'><b>Preço</b></div>
	<div class='col-sm-6'>{!! nl2br($dados['preco']) !!}</div>
</div>
<br>
...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$(document).find("#btn-delete").on("click", function(event) {
			var $this = $(this);
			$.ajax({
				url: "{{ route('faccao_tipo_de_servico.deletar') }}",
				dataType: 'json',
				...
				success: function(callback){
					if(callback.status === "success"){
						...
						message("Atenção", "Excluido com sucesso!");
					} else {
