...
<div class="row">
	<div class="col-sm-12">
		<b>Deseja realmente excluir esta Unidade Negócio?</b>
	</div>
</div>
<br>
...
<div class="row border-bottom">
	<div class='col-sm-6'><b>Gerente</b></div>
	<div class='col-sm-6'>{!! nl2br($dados['usuario']) !!}</div>
</div>
<br>
...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$(document).find("#btn-delete").on("click", function(event) {
			var $this = $(this);
			$.ajax({
				url: "{{ route('unidade_negocio.deletar') }}",
				dataType: 'json',
				...
				success: function(callback){
					if(callback.status === "success"){
						...
						message("Atenção", "Unidade Negócio excluído com sucesso!");
					} else {
