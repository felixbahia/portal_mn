...
<form action="" name="form_unidade_negocio" id="form_unidade_negocio" onsubmit="return false;">
    ...
    <div class="form-row">
        <div class="form-group col-sm-12"> 
            ...
            {{ Form::text('unidade', $dados['unidade'], ['id' => 'unidade', 'class' => 'form-control', 'placeholder' => 'Unidade', 'maxlength' => '250']) }}
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-sm-12"> 
            ...
            <div class="input-group" id="usuario_group">
                {{ Form::text('usuario_responsavel', $dados['usuario'], ['id' => 'usuario_responsavel', 'class' => 'form-control', 'placeholder' => 'Gerente da Unidade', 'maxlength' => '250']) }}
...
<script>
    ...
    function editarDados(data_form_modal){
        $.ajax({
            url: "{{ route('unidade_negocio.editar') }}", 
            dataType: 'json',
