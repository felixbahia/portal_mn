...
<form action="" name="form_importacao_edt" id="form_importacao_edt" onsubmit="return false;">
    ...
    {!! Form::hidden('outras_despesas', $dados['outras_despesas_total'], ['id' =>'outras_despesas']) !!}
    {!! Form::hidden('total_cambio', $dados['total_cambio_realizado'], ['id' =>'total_cambio']) !!}
    {!! Form::hidden('embarque_realizado', $dados['data_embarque_realizado'], ['id' => 'embarque_realizado']) !!}
    {!! Form::hidden('chegada_porto_realizado', $dados['data_chegada_porto_realizado'], ['id' => 'chegada_porto_realizado']) !!}
    ...
    <div class="tab-content pt-3" id="ImportacaoHeaderContainer">
        <div class="tab-pane show active" id="importacao_dados_gerais" role="tabpanel" aria-labelledby="dados-tab">
            <div class="form-row">
                <div class="form-group col-sm-3">
                    ...
                    <div class="input-group">
                        {{ Form::text('numero_proforma', $dados['proforma'], ['id' => 'numero_proforma', 'class' => 'form-control input-label', 'placeholder' => 'Proforma', 'readonly']) }}
                    </div>
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('pedido_compras', 'PCMN', []) !!}
                    {{ Form::text('pedido_compras', $dados['pcmn'], ['id' => 'pedido_compras', 'class' => 'form-control input-label', 'placeholder' => 'Pedido de Compras', 'readonly']) }}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('nota_importacao', 'Nota Importação', []) !!}
                    <div class="input-group">
                        {{ Form::text('nota_importacao', $dados['nota_importacao_numero'], ['id' => 'nota_importacao', 'class' => 'form-control input-label', 'placeholder' => 'Nota Importação', 'readonly']) }}
                    </div>
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('nota_remessa', 'Nota Remessa', []) !!}
                    {{ Form::text('nota_remessa', $dados['nota_remessa_numero'], ['id' => 'nota_remessa', 'class' => 'form-control input-label', 'placeholder' => 'Nota Remessa', 'readonly']) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-12">
                    ...
                    <div class="input-group">
                        {{ Form::text('fornecedor', $dados['fornecedor'], ['id' => 'fornecedor', 'class' => 'form-control input-label', 'placeholder' => 'Fornecedor', 'onkeyup' => "optionsFornecedor($(this))", 'readonly']) }}
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-2">
                    ...
                    {{ Form::text('referencia', $dados['referencia'], ['id' => 'referencia', 'class' => 'form-control input-label', 'placeholder' => 'Referência', 'maxlength' => 10, "data-tipo" => "string", 'onchange' => "salvarEmMudanca($(this))"]) }}
                </div>
                <div class="form-group col-sm-2">
                    {!! Form::label('data_proforma', 'Data da Proforma', []) !!}
                    {{ Form::text('data_proforma', $dados['data_proforma'], ['id' => 'data_proforma', 'class' => 'form-control input-label', 'placeholder' => 'Data da Proforma', 'readonly']) }}
                </div>
                <div class="form-group col-sm-2">
                    {!! Form::label('previsao_carta_programa', 'Previsão da Carta Programa', []) !!}
                    {{ Form::text('previsao_carta_programa', $dados['data_previsao_carta_programa'], ['id' => 'previsao_carta_programa', 'class' => 'form-control input-label data', 'placeholder' => 'Previsão da Carta Programa', "data-tipo" => "data", 'onchange' => "salvarEmMudanca($(this))"]) }}
                </div>
                <div class="form-group col-sm-2">
                    {!! Form::label('previsao_recebimento', 'Previsão de Recebimento', []) !!}
                    <div class=" mt-2">
                        <div class="previsao_recebimento_modificacao">
                            <a href='#' onclick="showModalData('{{ $dados['id_nota'] }}', '{{ $dados['estabelecimento_codigo'] }}', '{{$dados['data_proforma']}}')">{{$dados['data_previsao_recebimento']}}</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-12">
                    ...
                    <div class="input-group">
                        {{ Form::text('respresentante', $dados['respresentante'], ['id' => 'respresentante', 'class' => 'form-control input-label', 'placeholder' => 'Representante', 'onkeyup' => "optionsFornecedor($(this))", "data-tipo" => "string", 'onchange' => "salvarEmMudanca($(this))"]) }}
            ...
            <div class="form-row">
                <div class="form-group col-sm-12">
                    @if(!empty($dados['arquivos']['arquivo_carta_programa']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_carta_programa'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>Carta_Programa_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
                    {{ Form::label('arquivo_carta_programada', 'Carta Programada(Tamanho máximo 2 MB, favor converter antes de enviar)') }}
            ...
            <div class="content-dialog-table">
                <table class="table table-striped table-filter-dialog" id="table-filters-produtos-proforma">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="tb_number"><div><div data-toggle="tooltip" data-html="true" title="{{ $item['item'] }}">{{ $item['item'] }}</div></div></td>
                            <td><div><div data-toggle="tooltip" data-html="true" title="{{ $item['codigo'] }}">{!! $item['foto'] !!} {!! $item['codigo'] !!}</div></div></td>
                            <td><div><div data-toggle="tooltip" data-html="true" title="{{ $item['produto'] }}">{{ $item['produto'] }}</div></div></td>
                            <td><div><div data-toggle="tooltip" data-html="true" title="{{ $item['composicao'] }}">{{ $item['composicao'] }}</div></div></td>
                            <td class="tb_number"><div><div data-toggle="tooltip" data-html="true" title="{{ $item['gramatura_gm2'] }}">{{ $item['gramatura_gm2'] }}</div></div></td>
                            <td><div><div data-toggle="tooltip" data-html="true" title="{{ $item['largura'] }}">{{ $item['largura'] }}</div></div></td>
                            <td><div><div data-toggle="tooltip" data-html="true" title="{{ $item['gramatura_gml'] }}">{{ $item['gramatura_gml'] }}</div></div></td>
                            <td><div><div data-toggle="tooltip" data-html="true" title="{{ $item['rendimento'] }}">{{ $item['rendimento'] }}</div></div></td>
                            <td><div><div data-toggle="tooltip" data-html="true" title="{{ $item['instrucao_lavagem'] }}">{{ $item['instrucao_lavagem'] }}</div></div></td>
                            ...
                            <td class="tb_number">@if($item['status']!='Cancelado'){{ $item['preco_total'] }}@endif</td>
                            <td><input id="valor_contabil_unitario_{{$item['codigo']}}" data-codigo="{{$item['codigo']}}" data-quantidade="{{ $item['quantidade'] }}" data-quantidade_realizada="{{ $item['quantidade_realizada'] }}" data-preco_fob_total_unitario="{{ $item['preco_total'] }}" data-valor_fob_total="@if($item['status']!='Cancelado'){{ $item['preco_total'] }}@endif" class="form-control decimal_quatro_casas text-right" placeholder="Valor Contábil" maxlength="20" name="valor_contabil_unitario[]" type="text" value=@if($item['status']!='Cancelado')"{{$item['valor_contabil_unitario']}}"@else""@endif autocomplete="off" onkeyup='valorContabilUnitarioTotal($(this))' onchange="salvarEmMudancaProdutoContábil($(this))"></td>
                            <td class="tb_number"><div id="valor_contabil_total_{{$item['codigo']}}" name="valor_contabil_total_{{$item['codigo']}}">@if($item['status']!='Cancelado'){{$item['valor_contabil_total']}}@endif</div></td>
        ...
        <div class="tab-pane" id="importacao_follow_up_lead_time" role="tabpanel" aria-labelledby="dados-tab">
            <table class="table">
                ...
                <tr>
                    <td>Carga Pronta</td>
                    <td>{!! Form::text('carga_pronta_previsao', $dados['data_carga_pronta_previsao'], ['id' => 'carga_pronta_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Carga Pronta Previsão', "data-tipo" => "data", 'onchange' => "salvarEmMudanca($(this))"]) !!}</td>
                    <td>{!! Form::text('carga_pronta_realizado', $dados['data_carga_pronta_realizado'], ['id' => 'carga_pronta_realizado', 'class' => 'form-control input-label data', 'placeholder' => 'Carga Pronta Realizado', "data-tipo" => "data", 'onchange' => "salvarEmMudanca($(this))"]) !!}</td>
                </tr>
                <tr>
                    <td>Embarque ETD</td>
                    <td>{!! Form::text('embarque_previsao', $dados['data_embarque_previsao'], ['id' => 'embarque_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Embarque ETD Previsão', "data-tipo" => "data", 'onchange' => "salvarEmMudanca($(this))"]) !!}</td>
                    <td><div class="data_embarque_realizado">{{$dados['data_embarque_realizado']}}</div></td>
                </tr>
                <tr>
                    <td>Chegada no Porto ETA</td>
                    <td>{!! Form::text('chegada_porto_previsao', $dados['data_chegada_porto_previsao'], ['id' => 'chegada_porto_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Chegada no Porto ETA Previsão', "data-tipo" => "data", 'onchange' => "salvarEmMudanca($(this))"]) !!}</td>
                    <td><div class="data_chegada_porto_realizado">{{$dados['data_chegada_porto_realizado']}}</div></td>
                </tr>  
                <tr>
                    <td>Data DI</td>
                    <td>{!! Form::text('data_di_previsao', $dados['data_di_previsao'], ['id' => 'data_di_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Data DI Previsão', "data-tipo" => "data", 'onchange' => "salvarEmMudanca($(this))"]) !!}</td>
                    <td>{!! Form::text('data_di_realizado', $dados['data_di_realizado'], ['id' => 'data_di_realizado', 'class' => 'form-control input-label data', 'placeholder' => 'Data DI Realizado', "data-tipo" => "data", 'onchange' => "salvarEmMudanca($(this))"]) !!}</td>
                </tr>  
                <tr>
                    <td>Devolução CNTR</td>
                    <td>{!! Form::text('devolucao_cntr_previsao', $dados['data_devolucao_cntr_previsao'], ['id' => 'devolucao_cntr_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Devolução CNTR Previsão', "data-tipo" => "data", 'onchange' => "salvarEmMudanca($(this))"]) !!}</td>
                    <td>{!! Form::text('devolucao_cntr_realizado', $dados['data_devolucao_cntr_realizado'], ['id' => 'devolucao_cntr_realizado', 'class' => 'form-control input-label data', 'placeholder' => 'Devolução CNTR Realizado', "data-tipo" => "data", 'onchange' => "salvarEmMudanca($(this))"]) !!}</td>
                </tr>
            </table>
            <hr>
            <br/>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    {!! Form::select('envio_das_cores', $dados['tipos_cores'], $dados['dados_follow']['tipo_cor'], ['id' => 'envio_das_cores', 'class' => 'form-control input-label', 'placeholder' => 'Tipo de Cor']) !!}
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-3">
                    {!! Form::label('envio_das_cores_previsao', 'Previsão do Envio', []) !!}
                    {!! Form::text('envio_das_cores_previsao', $dados['dados_follow']['envio_cor_data_previsao'], ['id' => 'envio_das_cores_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Envio Das Cores Previsão', 'readonly']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('envio_das_cores_enviado', 'Envio', []) !!}
                    {!! Form::text('envio_das_cores_enviado', $dados['dados_follow']['envio_cor_data_envio'], ['id' => 'envio_das_cores_enviado', 'class' => 'form-control input-label data', 'placeholder' => 'Envio Das Cores Enviado']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('envio_das_cores_recebido', 'Recebido', []) !!}
                    {!! Form::text('envio_das_cores_recebido', $dados['dados_follow']['envio_cor_data_recebido'], ['id' => 'envio_das_cores_recebido', 'class' => 'form-control input-label data', 'placeholder' => 'Envio Das Cores Recebido']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('envio_das_cores_revisao', 'Revisão', []) !!}
                    {!! Form::text('envio_das_cores_revisao', $dados['dados_follow']['envio_cor_data_revisao'], ['id' => 'envio_das_cores_revisao', 'class' => 'form-control input-label data', 'placeholder' => 'Envio Das Cores Revisão']) !!}
                </div>
            </div>
            <hr>
            ...
            <div class="row">   
                <div class="form-group col-sm-2">
                    ...
                    {!! Form::text('quality_sample_previsao', $dados['dados_follow']['quality_sample_data_previsao_envio'], ['id' => 'quality_sample_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Quality Sample Previsão' , 'readonly']) !!}
                </div>
                <div class="form-group col-sm-2">
                    {!! Form::label('quality_sample_enviado', 'Envio', []) !!}
                    {!! Form::text('quality_sample_enviado', $dados['dados_follow']['quality_sample_data_envio'], ['id' => 'quality_sample_enviado', 'class' => 'form-control input-label data', 'placeholder' => 'Quality Sample Enviado']) !!}
                </div>
                
                <div class="form-group col-sm-3">
                    {!! Form::label('quality_sample_transportadora', 'Transportadora', []) !!}
                    {!! Form::text('quality_sample_transportadora', $dados['dados_follow']['quality_sample_transportadora'], ['id' => 'quality_sample_transportadora', 'class' => 'form-control input-label', 'placeholder' => 'Quality Sample Transportadora']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('quality_sample_awb', 'AWB', []) !!}
                    {!! Form::text('quality_sample_awb', $dados['dados_follow']['quality_sample_awb'], ['id' => 'quality_sample_awb', 'class' => 'form-control input-label', 'placeholder' => 'Quality Sample AWB']) !!}
                </div>
                <div class="form-group col-sm-2">
                    {!! Form::label('quality_sample_recebido', 'Recebido', []) !!}
                    {!! Form::text('quality_sample_recebido', $dados['dados_follow']['quality_sample_data_recebido'], ['id' => 'quality_sample_recebido', 'class' => 'form-control input-label data', 'placeholder' => 'Quality Sample Recebido']) !!}
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-6">
                    {!! Form::label('aprovacao_quality_sample', 'Status da Aprovação', []) !!}
                    {!! Form::select('aprovacao_quality_sample', $dados['tipo_aprovacoes_simples'], $dados['dados_follow']['quality_sample_aprovacao'], ['id' => 'aprovacao_quality_sample', 'class' => 'form-control input-label', 'placeholder' => 'Status da Aprovação']) !!}
                </div> 
                <div class="form-group col-sm-3">
                    {!! Form::label('aprovacao_quality_sample_previsao', 'Previsão Aprovação', []) !!}
                    {!! Form::text('aprovacao_quality_sample_previsao', $dados['dados_follow']['quality_sample_data_previsao_aprovacao'], ['id' => 'aprovacao_quality_sample_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Aprovação Quality Sample Previsão', 'readonly']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('aprovacao_quality_sample_previsao', 'Data Aprovação', []) !!}
                    <div class="input-group">
                        {!! Form::text('aprovacao_quality_sample_realizado', $dados['dados_follow']['quality_sample_data_aprovacao'], ['id' => 'aprovacao_quality_sample_realizado', 'class' => 'form-control input-label data', 'placeholder' => 'Aprovação Quality Sample Realizado']) !!}
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    {!! Form::text('laboratorio_previsao', $dados['dados_follow']['laboratorio_data_previsao_envio'], ['id' => 'laboratorio_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Laboratório(Lab Dip/ Handlooms / Strike Off) Previsão' , 'onchange' => "salvarEmMudanca($(this))", 'readonly']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('laboratorio_enviado', 'Envio', []) !!}
                    {!! Form::text('laboratorio_enviado', $dados['dados_follow']['laboratorio_data_envio'], ['id' => 'laboratorio_enviado', 'class' => 'form-control input-label data', 'placeholder' => 'Laboratório(Lab Dip/ Handlooms / Strike Off) Enviado' , 'onchange' => "salvarEmMudanca($(this))"]) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('laboratorio_recebido', 'Recebido', []) !!}
                    {!! Form::text('laboratorio_recebido', $dados['dados_follow']['laboratorio_data_recebido'], ['id' => 'laboratorio_recebido', 'class' => 'form-control input-label data', 'placeholder' => 'Laboratório(Lab Dip/ Handlooms / Strike Off) Recebido' , 'onchange' => "salvarEmMudanca($(this))"]) !!}
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-6">
                    {!! Form::label('aprovacao_laboratorio', 'Status da Aprovação', []) !!}
                    {!! Form::select('aprovacao_laboratorio', $dados['tipo_aprovacoes_parcial'], $dados['dados_follow']['laboratorio_aprovacao'], ['id' => 'aprovacao_laboratorio', 'class' => 'form-control input-label', 'placeholder' => 'Status da Aprovação']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('aprovacao_laboratorio_realizado', 'Data Aprovação', []) !!}
                    <div class="input-group">
                        {!! Form::text('aprovacao_laboratorio_realizado', $dados['dados_follow']['laboratorio_data_aprovacao'], ['id' => 'aprovacao_laboratorio_realizado', 'class' => 'form-control input-label data', 'placeholder' => 'Aprovação Laboratório Realizado' , 'onchange' => "salvarEmMudanca($(this))"]) !!}
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    {!! Form::text('tempo_producao_previsao', $dados['dados_follow']['tempo_producao_previsao_termino'], ['id' => 'tempo_producao_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Tempo de Produção Previsão' , 'onchange' => "salvarEmMudanca($(this))", 'readonly']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('tempo_producao', 'Termino', []) !!}
                    {!! Form::text('tempo_producao', $dados['dados_follow']['tempo_producao_termino'], ['id' => 'tempo_producao', 'class' => 'form-control input-label data', 'placeholder' => 'Tempo de Produção' , 'onchange' => "salvarEmMudanca($(this))"]) !!}
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="form-group col-sm-2">
                    ...
                    {!! Form::text('amostra_embarque_previsao', $dados['dados_follow']['amostra_embarque_data_previsao_envio'], ['id' => 'amostra_embarque_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Amostra Embarque Previsão', 'readonly']) !!}
                </div>
                <div class="form-group col-sm-2">
                    {!! Form::label('amostra_embarque_enviado', 'Envio', []) !!}
                    {!! Form::text('amostra_embarque_enviado', $dados['dados_follow']['amostra_embarque_data_envio'], ['id' => 'amostra_embarque_enviado', 'class' => 'form-control input-label data', 'placeholder' => 'Amostra Embarque Enviado']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('amostra_embarque_transportadora', 'Transportadora', []) !!}
                    {!! Form::text('amostra_embarque_transportadora', $dados['dados_follow']['amostra_embarque_transportadora'], ['id' => 'amostra_embarque_transportadora', 'class' => 'form-control input-label', 'placeholder' => 'Amostra Embarque Transportadora']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('amostra_embarque_awb', 'AWB', []) !!}
                    {!! Form::text('amostra_embarque_awb', $dados['dados_follow']['amostra_embarque_awb'], ['id' => 'amostra_embarque_awb', 'class' => 'form-control input-label', 'placeholder' => 'Amostra Embarque AWB']) !!}
                </div>
                <div class="form-group col-sm-2">
                    {!! Form::label('amostra_embarque_recebido', 'Recebido', []) !!}
                    {!! Form::text('amostra_embarque_recebido', $dados['dados_follow']['amostra_embarque_data_recebido'], ['id' => 'amostra_embarque_recebido', 'class' => 'form-control input-label data', 'placeholder' => 'Amostra Embarque Recebido' ]) !!}
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-6">
                    {!! Form::label('aprovacao_amostra_embarque', 'Status da Aprovação', []) !!}
                    {!! Form::select('aprovacao_amostra_embarque', $dados['tipo_aprovacoes_parcial'], $dados['dados_follow']['amostra_embarque_aprovacao'], ['id' => 'aprovacao_amostra_embarque', 'class' => 'form-control input-label', 'placeholder' => 'Status da Aprovação']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('aprovacao_amostra_embarque_previsao', 'Previsão da Aprovação', []) !!}
                    {!! Form::text('aprovacao_amostra_embarque_previsao', $dados['dados_follow']['amostra_embarque_data_previsao_aprovacao'], ['id' => 'aprovacao_amostra_embarque_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Aprovação Amostra Embarque Previsão','readonly']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('aprovacao_amostra_embarque_enviado', 'Aprovação', []) !!}
                    <div class="input-group">
                        {!! Form::text('aprovacao_amostra_embarque_enviado', $dados['dados_follow']['amostra_embarque_data_envio'], ['id' => 'aprovacao_amostra_embarque_enviado', 'class' => 'form-control input-label data', 'placeholder' => 'Aprovação Amostra Embarque Enviado']) !!}
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    {!! Form::text('autorizacao_embarque_previsao', $dados['dados_follow']['autorizacao_embarque_data_previsao_envio'], ['id' => 'autorizacao_embarque_previsao', 'class' => 'form-control input-label data', 'placeholder' => 'Autorizacao de Embarque Previsão' , 'onchange' => "salvarEmMudanca($(this))", 'readonly']) !!}
                </div>
                <div class="form-group col-sm-3">
                    {!! Form::label('autorizacao_embarque_enviado', 'Envio', []) !!}
                    {!! Form::text('autorizacao_embarque_enviado', $dados['dados_follow']['autorizacao_embarque_data_envio'], ['id' => 'autorizacao_embarque_enviado', 'class' => 'form-control input-label data', 'placeholder' => 'Autorizacao de Embarque Enviado' , 'onchange' => "salvarEmMudanca($(this))"]) !!}
                </div>
            </div>
        </div>
        <div class="tab-pane" id="importacao_dados_adicionais_embarque" role="tabpanel" aria-labelledby="dados-tab">
            <div class="form-row">
                <div class="form-group col-sm-12">
                    ...
                    {{ Form::text('porto_origem', $dados['porto_origem'], ['id' => 'porto_origem', 'class' => 'form-control input-label', 'placeholder' => 'Porto Origem', "data-tipo" => "string", 'onchange' => "salvarEmMudancaEmbarque($(this))"]) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-12">
                    {!! Form::label('porto_destino', 'Porto Destino', []) !!}
                    {{ Form::text('porto_destino', $dados['porto_destino'], ['id' => 'porto_destino', 'class' => 'form-control input-label', 'placeholder' => 'Porto Destino', "data-tipo" => "string", 'onchange' => "salvarEmMudancaEmbarque($(this))"]) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-6">
                    {!! Form::label('agente_compra', 'Agente de Compras', []) !!}
                    {{ Form::text('agente_compra', $dados['agente_compra'], ['id' => 'agente_compra', 'class' => 'form-control input-label', 'placeholder' => 'Agente de Compras', "data-tipo" => "string", 'onchange' => "salvarEmMudancaEmbarque($(this))"]) }}
                </div>
                <div class="form-group col-sm-6">
                    {!! Form::label('armador', 'Armador', []) !!}
                    {{ Form::text('armador', $dados['armador'], ['id' => 'armador', 'class' => 'form-control input-label', 'placeholder' => 'Armador', "data-tipo" => "string", 'onchange' => "salvarEmMudancaEmbarque($(this))"]) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-3">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-sm-9">
                    @if($dados['etd_booking'])
                    {{ Form::checkbox('etd_booking', 'etd_booking', '', ['class' => 'form-check-input', 'id'=>'etd_booking','checked', "data-tipo" => "bool", 'onchange' => "salvarEmMudancaEmbarque($(this))"]) }}
                    @else 
                    {{ Form::checkbox('etd_booking', 'etd_booking', '', ['class' => 'form-check-input', 'id'=>'etd_booking', "data-tipo" => "bool", 'onchange' => "salvarEmMudancaEmbarque($(this))"]) }}
                    @endif
                    @if(empty($dados['data_embarque_realizado']))
                    {{ Form::label('label_etd_booking', 'Confirmado', ['id' => 'label_etd_booking', 'class'=>'form-check-label']) }}
                    @else 
                    {{ Form::label('label_etd_booking', 'Confirmado('.$dados['data_embarque_realizado'].')', ['id' => 'label_etd_booking', 'class'=>'form-check-label']) }}
                    @endif
                </div>
            </div>
            <div class="form-row">
                ...
                <div class="form-group col-sm-9">
                    @if($dados['eta_booking'])
                    {{ Form::checkbox('eta_booking', 'eta_booking', '', ['class' => 'form-check-input', 'id'=>'eta_booking','checked']) }}
                    @else
                    {{ Form::checkbox('eta_booking', 'eta_booking', '', ['class' => 'form-check-input', 'id'=>'eta_booking']) }}
                    @endif
                    @if(empty($dados['data_chegada_porto_realizado']))
                    {{ Form::label('label_eta_booking', 'Confirmado', ['id' => 'label_eta_booking', 'class'=>'form-check-label']) }}
                    @else 
                    {{ Form::label('label_eta_booking', 'Confirmado('.$dados['data_chegada_porto_realizado'].')', ['id' => 'label_eta_booking', 'class'=>'form-check-label']) }}
                    @endif
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-6">
                    ...
                    {{ Form::text('numero_bl', $dados['numero_bl'], ['id' => 'numero_bl', 'class' => 'form-control input-label', 'placeholder' => 'Nº B/L', "data-tipo" => "string", 'onchange' => "salvarEmMudancaEmbarque($(this))"]) }}
                </div>
                <div class="form-group col-sm-6">
        ...
        <div class="tab-pane" id="importacao_documentos_processos" role="tabpanel" aria-labelledby="dados-tab">
            <div class="form-row">
                <div class="form-group col-sm-12"> 
                    @if(!empty($dados['arquivos']['arquivo_proforma']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_proforma'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>Proforma_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12">
                    @if(!empty($dados['arquivos']['arquivo_conciliator_invoice']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_conciliator_invoice'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>Comercial_Invoice_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12">
                    @if(!empty($dados['arquivos']['arquivo_packing_list']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_packing_list'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>Packing_List_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12">
                    @if(!empty($dados['arquivos']['arquivo_bl']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_bl'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>B_L_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12"> 
                    @if(!empty($dados['arquivos']['arquivo_contrato_cambio']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_contrato_cambio'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>Contrato_de_Câmbio_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12"> 
                    @if(!empty($dados['arquivos']['arquivo_nf_importacao']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_nf_importacao'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>NF_de_Importação_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12"> 
                    @if(!empty($dados['arquivos']['arquivo_exoneracao']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_exoneracao'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>Exoneração_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12"> 
                    @if(!empty($dados['arquivos']['arquivo_nf_remessa']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_nf_remessa'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>NF_Remessa_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12"> 
                    @if(!empty($dados['arquivos']['arquivo_di']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_di'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>DI_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12"> 
                    @if(!empty($dados['arquivos']['arquivo_ci']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_ci'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>CI_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12"> 
                    @if(!empty($dados['arquivos']['arquivo_fechamento_processo']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_fechamento_processo'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>Fechamento_do_Processo_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12"> 
                    @if(!empty($dados['arquivos']['arquivo_armazenagem']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_armazenagem'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>Armazenagem_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
            ...
            <div class="form-row">
                <div class="form-group col-sm-12"> 
                    @if(!empty($dados['arquivos']['arquivo_afrmm']))
                    {{ Form::label('arquivo', 'Arquivo') }}
                    <div class="form-group col-sm-12">
                        @foreach($dados['arquivos']['arquivo_afrmm'] as $index => $arquivo)
                            <a href="{{ asset($arquivo) }}" target="_blank"><i class="fas fa-file-alt"></i>AFRMM_{{$index}}</a>
                        @endforeach
                    </div>
                    @endif
        ...
        <div class="tab-pane" id="importacao_financeiro" role="tabpanel" aria-labelledby="dados-tab">
            <div class="form-row">
                <div class="form-group col-sm-12">
                    ...
                    {{ Form::text('data_embarque_financeiro', $dados['data_embarque_realizado'], ['id' => 'data_embarque_financeiro', 'class' => 'form-control data input-label', 'placeholder' => 'Data Embarque', "data-tipo" => "data", 'readonly']) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-12">
                    {!! Form::label('valor_fob_devido', 'Valor FOB Devido', []) !!}
                    {{ Form::text('valor_fob_devido', $dados['total']['preco_fob'], ['id' => 'valor_fob_devido', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Valor FOB Devido', 'readonly']) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-12">
                    ...
                    <div class="input-group">
                        {{ Form::text('valor_fob_pago', $dados['valor_fob_pago'], ['id' => 'valor_fob_pago', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Valor FOB Pago', 'readonly']) }}
            ...
            <div class="form-row">
                <div class="form-group col-sm-12">
                    {!! Form::label('valor_fob_saldo', 'Valor FOB Saldo', []) !!}
                    {{ Form::text('valor_fob_saldo',  parserNumber($dados['total']['preco_fob']) - parserNumber($dados['valor_fob_pago']) < 0? '' : parserValor(parserNumber($dados['total']['preco_fob']) - parserNumber($dados['valor_fob_pago'])), ['id' => 'valor_fob_saldo', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Valor FOB Saldo', 'readonly']) }}
                </div>
            </div>          
            <div class="form-row">
                <div class="form-group col-sm-12">
                    {!! Form::label('valor_contabil_financeiro', 'Valor Contábil', []) !!}
                    {{ Form::text('valor_contabil_financeiro', $dados['total']['preco_contabil'], ['id' => 'valor_contabil_financeiro', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Valor Contábil', 'readonly']) }}
                </div>
            </div>
            <div class="form-row">
                @if(parserNumber($dados['total']['preco_contabil']) > parserNumber($dados['total']['preco_fob']))
                <div class="form-group col-sm-12">
                    {!! Form::label('debito_credito_financeiro', 'Crédito', ['id' => 'label_debito_credito_financeiro']) !!}
                    {{ Form::text('debito_credito_financeiro', $dados['total']['diferenca_preco'], ['id' => 'debito_credito_financeiro', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Crédito', 'readonly']) }}
                </div>
                @else
                <div class="form-group col-sm-12">
                    {!! Form::label('debito_credito_financeiro', 'Débito', ['id' => 'label_debito_credito_financeiro']) !!}
                    {{ Form::text('debito_credito_financeiro', $dados['total']['diferenca_preco'], ['id' => 'debito_credito_financeiro', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Débito', 'readonly']) }}
                </div>
                @endif
            </div>
        </div>
        <div class="tab-pane" id="importacao_custo" role="tabpanel" aria-labelledby="dados-tab">
            <div class="form-row">
                <div class="form-group col-sm-4">
                    {!! Form::label('ii', 'II', []) !!}
                    {{ Form::text('ii', $dados['ii'], ['id' => 'ii', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'II', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('ipi', 'IPI', []) !!}
                    {{ Form::text('ipi', $dados['ipi'], ['id' => 'ipi', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'ipi', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('pis', 'PIS', []) !!}
                    {{ Form::text('pis', $dados['pis'], ['id' => 'pis', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'PIS', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-4">
                    {!! Form::label('cofins', 'COFINS', []) !!}
                    {{ Form::text('cofins', $dados['cofins'], ['id' => 'cofins', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'COFINS', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('afrmm', 'AFRMM', []) !!}
                    {{ Form::text('afrmm', $dados['afrmm'], ['id' => 'afrmm', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'AFRMM', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('taxa_siscomex', 'Taxa Siscomex', []) !!}
                    {{ Form::text('taxa_siscomex', $dados['taxa_siscomex'], ['id' => 'taxa_siscomex', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Taxa Siscomex', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-4">
                    {!! Form::label('sda', 'SDA', []) !!}
                    {{ Form::text('sda', $dados['sda'], ['id' => 'sda', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'SDA']) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('honorarios', 'Honorários', []) !!}
                    {{ Form::text('honorarios', $dados['honorarios'], ['id' => 'honorarios', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Honorários', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('expediente', 'Expediente', []) !!}
                    {{ Form::text('expediente', $dados['expediente'], ['id' => 'expediente', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Expediente', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-4">
                    {!! Form::label('valor_li', 'Valor Li', []) !!}
                    {{ Form::text('valor_li', $dados['valor_li'], ['id' => 'valor_li', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Valor Li', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('agencia_maritima', 'Agência Marítima', []) !!}
                    {{ Form::text('agencia_maritima', $dados['agencia_maritima'], ['id' => 'agencia_maritima', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Agência Marítima', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('armazem', 'Armazenagem', []) !!}
                    {{ Form::text('armazem', $dados['armazem'], ['id' => 'armazem', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Armazenagem', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-4">
                    {!! Form::label('laudo', 'Laudo', []) !!}
                    {{ Form::text('laudo', $dados['laudo'], ['id' => 'laudo', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Laudo', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('icms_saida', 'ICMS Remessa', []) !!}
                    {{ Form::text('icms_saida', $dados['icms_saida'], ['id' => 'icms_saida', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'ICMS Saída', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('icms_a_pagar', 'ICMS À Pagar', []) !!}
                    {{ Form::text('icms_a_pagar', $dados['icms_a_pagar'], ['id' => 'icms_a_pagar', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'ICMS Saída', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-4">
                    {!! Form::label('transporte_rodoviario', 'Transporte Rodoviário', []) !!}
                    {{ Form::text('transporte_rodoviario', $dados['transporte_rodoviario'], ['id' => 'transporte_rodoviario', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Transporte Rodoviário', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('seguro', 'Seguro', []) !!}
                    {{ Form::text('seguro', $dados['seguro'], ['id' => 'seguro', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Seguro', "data-tipo" => "numerico", 'onchange' => "salvarEmMudancaCusto($(this))"]) }}
                </div>
                <div class="form-group col-sm-4">
                    {!! Form::label('frete_fornecedor', 'Frete Fornecedor(US$)', []) !!}
                    {{ Form::text('frete_fornecedor', $dados['frete_fornecedor'], ['id' => 'frete_fornecedor', 'class' => 'form-control decimal text-right input-label', 'placeholder' => 'Frete Fornecedor(US$)', "data-tipo" => "numerico", 'onchange' => "salvarEmMudanca($(this))", 'onkeyup' => 'valorContabilUnitarioTotal($(this))']) }}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm-4">
            ...
            <div class="content-dialog-table">
                <div class="content-table">
                    <table class="table table-striped" id="table-outras_despesas">
                        ...
                        <tbody>
                            @foreach ($dados['outras_despesas'] as $item)
                            <tr>
                                <td>{{$item['descricao']}}</td>
                                <td class="tb_number">{{$item['valor']}}</td>
                                <td class="td_acao"><a href="#" data-id="{{$item['id']}}" data-modal="" data-title_modal="Excluir Despesa" class="bt-delete" data-placement="top" title="Excluir" onclick="excluirDespesa($(this), $(this).parents('tr'))"></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                            <td class="tb_number">Total:</td>
                            <td class="tb_number" id='outras_despesas_total'>{{$dados['outras_despesas_total']}}</td>
                            <td class="td_acao"></td>
                        </tfoot>
                    </table>
                </div>
        ...
        <div class="tab-pane" id="importacao_custo_realizado_x_previsto" role="tabpanel" aria-labelledby="dados-tab">
            <table class="table">
                ...
                <tr>
                    <td>ICMS À Pagar</td>
                    <td class="text-right border-right" id="icms_a_pagar_realizado"></td>
                    <td class="text-right border-right" id="icms_a_pagar_previsto"></td>
                    <td class="text-right border-right" id="icms_a_pagar_diferenca"></td>
                </tr>
                <tr>
...
<script>
    ...
    transporte_rodoviario_previsto  = "{{$dados['custo_previsto']['transporte_rodoviario_previsto']}}";
    icms_a_pagar_previsto = "{{$dados['custo_previsto']['icms_a_pagar_previsto']}}";
    ...
    $(document).ready( function () {
        ...
        form_modal_importacao.find(".decimal_quatro_casas").maskMoney({thousands:'.', decimal:',', precision: 4});
    ...
    function optionsAutoCompleteFornecedor($this){
        ...
        return {
            ...
            open: function( event, ui ){
                $('.ui-autocomplete').css("z-index", (parseInt($('#modal_importacao_edit_delete').css('z-index')) + 1));
            },
    ...
    function valorContabilUnitarioTotal($this){
        ...
        produto_array.forEach(function imprimir(item){
            ...
            valor_fob_total = form_modal_importacao.find("#valor_contabil_unitario_"+item).data("valor_fob_total");
            ...
            if(valor_fob_total == "" || $.isEmptyObject(valor_fob_total)){
                valor_fob_total = 0;
            }else{
                valor_fob_total = valor_fob_total.replace(/\./g,"").replace(/\,/g, ".");
                valor_fob_total = parseFloat(valor_fob_total);
            }

            valor_contabil_total = valor_contabil * quantidade;
            valor_contabil_total_total = valor_contabil_total_total + valor_contabil_total;
            valor_fob_devido_total = valor_fob_devido_total + valor_fob_total; 
        });
        
        if(valor_contabil_total_total == 0){
            valor_contabil_total_total = '';
        }else{
            valor_contabil_total_total = numberToReal(valor_contabil_total_total.toFixed(4));
        }

        if(valor_fob_devido_total == 0){
            valor_fob_devido_total = '';
        }else{
            valor_fob_devido_total = numberToReal(valor_fob_devido_total.toFixed(4));
        }
        ...
        form_modal_importacao.find("#valor_fob_devido").val(valor_fob_devido_total);
        ...
        frete_fornecedor = form_modal_importacao.find("#frete_fornecedor").val();
        if(frete_fornecedor == "" || $.isEmptyObject(frete_fornecedor)){
            frete_fornecedor = 0;
        }else{
            frete_fornecedor = frete_fornecedor.replace(/\./g,"").replace(/\,/g, ".");
            frete_fornecedor = parseFloat(frete_fornecedor);
        }

        form_modal_importacao.find("#valor_fob_devido").val(numberToReal((valor_fob_devido + frete_fornecedor).toFixed(2)));
        form_modal_importacao.find("#valor_contabil_financeiro").val(numberToReal((valor_contabil_financeiro + frete_fornecedor).toFixed(2)));
    }
    ...
    function calculoRateio(){
        ...
        icms_a_pagar = form_modal_importacao.find("#icms_a_pagar").val();
        ...
        produto_array.forEach(function imprimir(item){
            quantidade = form_modal_importacao.find("#valor_contabil_unitario_"+item).data("quantidade");
            quantidade_realizada = form_modal_importacao.find("#valor_contabil_unitario_"+item).data("quantidade_realizada");
            preco_fob_total_unitario = form_modal_importacao.find("#valor_contabil_unitario_"+item).data("preco_fob_total_unitario");
            ...
            if(quantidade_realizada == 0){
                form_modal_importacao.find("#valor_rateio_"+item).html('');
                form_modal_importacao.find("#valor_rateio_previsto_"+item).html('');
            }else{
    ...
    function resultado(form_modal_importacao){
        ...
        if(icms_a_pagar_previsto == "" || $.isEmptyObject(icms_a_pagar_previsto)){
            icms_a_pagar_previsto = 0;
        }else{
            icms_a_pagar_previsto = icms_a_pagar_previsto.replace(/\./g,"").replace(/\,/g, ".");
            icms_a_pagar_previsto = parseFloat(icms_a_pagar_previsto);
        }
        ...
        icms_a_pagar_diferenca = icms_a_pagar - icms_a_pagar_previsto;
        custo_total_a_ser_realizado = custo_total+total_cambio_a_ser_realizado;

        form_modal_importacao.find("#total_cambio_realizado").html(form_modal_importacao.find("#total_cambio").val() + " / {{((parserNumber($dados['total']['preco_fob']) - parserNumber($dados['valor_fob_pago'])) * $dados['cotacao_dolar']) < 0? '' : parserValor(((parserNumber($dados['total']['preco_fob']) - parserNumber($dados['valor_fob_pago'])) * $dados['cotacao_dolar']))}}");
        ...
        form_modal_importacao.find("#icms_a_pagar_realizado").html(form_modal_importacao.find("#icms_a_pagar").val());
        ...
        form_modal_importacao.find("#total_realizado").html(numberToReal(custo_total.toFixed(2))+" / "+numberToReal(custo_total_a_ser_realizado.toFixed(2)));
        ...
        icms_a_pagar_previsto = numberToReal(icms_a_pagar_previsto.toFixed(2));
        ...
        form_modal_importacao.find("#icms_a_pagar_previsto").html(icms_a_pagar_previsto);
        ...
        form_modal_importacao.find("#icms_a_pagar_diferenca").html(numberToReal(icms_a_pagar_diferenca.toFixed(2)));
    ...
    function salvarEmMudancaProdutoContábil($this){
        ...
        limparMesagemErroEdt(form_modal_importacao);
        $.ajax({
            url: '{{ route('importacao.adicionar_mudanca_valor_produto_contabil')}}',
            data: {
                _token: '{{csrf_token()}}',
                id: id,
                campo: campo,
