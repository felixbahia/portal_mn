...
<div class="row">
	<div class="col-sm-12">
		<b>Deseja realmente excluir este Faturamento Previsto?</b>
	</div>
</div>
<br>
...
<div class="row border-bottom">
	<div class='col-sm-6'><b>Valor Nacional</b></div>
	<div class='col-sm-6'>{{ $dados['nacional_valor'] }}</div>
</div>
<div class="row border-bottom">
	<div class='col-sm-6'><b>Valor Importado</b></div>
	<div class='col-sm-6'>{{ $dados['importado_valor'] }}</div>
</div>
<br>
...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$(document).find("#btn-delete").on("click", function(event) {
			var $this = $(this);
			$.ajax({
				url: "{{ route('faturamento_previsto.deletar') }}",
				dataType: 'json',
				...
				success: function(callback){
					if(callback.status === "success"){
						...
						message("Atenção", "Faturamento Previsto excluído com sucesso!");
					} else {
