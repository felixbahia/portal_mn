...
@section('content')
<form action="" name="form_faturamento_previsto" id="form_faturamento_previsto" onsubmit="return false;">
    @csrf
    ...
    <div class="form-row">
        <div class="form-group col-sm-12">
            {{ Form::label('nacional_valor', 'Valor Nacional', []) }}
            {!! Form::text('nacional_valor', $dados['nacional_valor'], ['id' => 'nacional_valor', 'class' => 'form-control moeda text-right', 'placeholder' => 'Valor Nacional']) !!}
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-sm-12">
            {{ Form::label('importado_valor', 'Valor Importado', []) }}
            {!! Form::text('importado_valor', $dados['importado_valor'], ['id' => 'importado_valor', 'class' => 'form-control moeda text-right', 'placeholder' => 'Valor Importado']) !!}
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        form_modal = $(document).find("#form_faturamento_previsto");
    ...
    function editarDados(form_modal){
        ...
        $.ajax({
            url: "{{ route('faturamento_previsto.editar') }}", 
            dataType: 'json',
