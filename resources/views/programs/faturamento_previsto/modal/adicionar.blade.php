...
<form action="" name="form_faturamento_previsto" id="form_faturamento_previsto" onsubmit="return false;">
    ...
    <div class="form-row">
        <div class="form-group col-sm-12">
            ...
            {!! Form::text('nacional_valor', '', ['id' => 'nacional_valor', 'class' => 'form-control moeda text-right', 'placeholder' => 'Valor Nacional']) !!}
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-sm-12">
            {{ Form::label('importado_valor', 'Valor Importado', []) }}
            {!! Form::text('importado_valor', '', ['id' => 'importado_valor', 'class' => 'form-control moeda text-right', 'placeholder' => 'Valor Importado']) !!}
        </div>
    </div>
...
<script>
    ...
    function inserirDados(form_modal){
        ...
        $.ajax({
            url: "{{ route('faturamento_previsto.adicionar') }}", 
            dataType: 'json',
