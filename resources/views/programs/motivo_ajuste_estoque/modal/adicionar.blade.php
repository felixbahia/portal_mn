...
<form action="#" id="frm_cad_motivo_add" name="frm_cad_motivo_add" onsubmit="return false;">
    @csrf
    <div class="form-row">
...
<script>
    $(document).ready( function () {
        form_modal = $(document).find('#frm_cad_motivo_add');
    ...
    function inserirDados(form_modal){
        ...
        $.ajax({
            url: "{{ route('produto.ajuste_estoque.motivo.adicionar') }}", 
            dataType: 'json',
