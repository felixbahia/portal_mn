...
function createBtViewClienteAtraso($this){
    var html = "<a href=\"#\" data-route=\"{{ route('analise_atrasos_equipe.modal.cliente') }}\" data-filter=\""+$this.filter+"\" data-abertura='aberto' data-cliete='true' data-abertura-geral='false' data-total='false' data-title='TITULOS FATURADOS - CLIENTE - Representante - "+$this.estabelecimento+"' class='bt-view bt-clinete-atraso'></a>"
    return html;
}

function createBtViewRepresentanteAtraso($this){
    var html = "<a href=\"#\" data-route=\"{{ route('analise_atrasos_equipe.modal.representantes') }}\" data-filter=\""+$this.filter+"\" data-title='TITULOS FATURADOS - Representante - "+$this.estabelecimento+"' data-abertura='total' data-total='false' data-representante='true'  class='bt-view bt-representante-atraso'></a>"
    return html;
}

function createBtViewAbertoAtraso($this){
    var html = "<a href=\"#\" data-route=\"{{ route('analise_atrasos_equipe.modal.titulo.titulos_abertura') }}\" data-abertura='aberto' data-total='false' data-filter=\""+$this.filter+"\" data-title='TITULOS FATURADOS - ABERTO - "+$this.estabelecimento+"' class='bt-titulos-abertos'>"+$this.aberto+"</a>"
    return html;
}

function createBtViewVencidoAtraso($this){
    var html = "<a href=\"#\" data-route=\"{{ route('analise_atrasos_equipe.modal.titulo.titulos_abertura') }}\" data-abertura='vencido' data-total='false' data-filter=\""+$this.filter+"\" data-title='TITULOS FATURADOS - VENCIDO -"+$this.estabelecimento+"' class='bt-titulos-vencidos'>"+$this.vencido+"</a>"
    return html;
}

function createBtViewTotal($this){
    var html = "<a href=\"#\" data-route=\"{{ route('analise_atrasos_equipe.modal.titulo.titulos_abertura') }}\" data-abertura='total' data-total='false' data-filter=\""+$this.filter+"\" data-title='TITULOS FATURADOS - TOTAL - "+$this.estabelecimento+"' class='bt-titulos-total'>"+$this.total+"</a>"
    return html;
}

function createBtViewTotalAberto($this){
    var html = "<a href=\"#\" data-route=\"{{ route('analise_atrasos_equipe.modal.titulo.titulos_abertura') }}\" data-abertura='aberto' data-total='true' data-filter=\""+$this.filter+"\" data-title='TITULOS FATURADOS - ABERTO - TODOS' class='bt-titulos-total-aberto'>"+$this.aberto+"</a>"
    return html;
}

function createBtViewTotalVencido($this){
    var html = "<a href=\"#\" data-route=\"{{ route('analise_atrasos_equipe.modal.titulo.titulos_abertura') }}\" data-abertura='vencido' data-total='true' data-filter=\""+$this.filter+"\" data-title='TITULOS FATURADOS - VENCIDO - TODOS' class='bt-titulos-total-vencido'>"+$this.vencido+"</a>"
    return html;
}

function createBtViewTotalAberturas($this){
    var html = "<a href=\"#\" data-route=\"{{ route('analise_atrasos_equipe.modal.titulo.titulos_abertura') }}\" data-abertura='total' data-total='true' data-filter=\""+$this.filter+"\" data-title='TITULOS FATURADOS - TOTAL - TODOS' class='bt-titulos-total-geral'>"+$this.total+"</a>"
    return html;
}

function createBtViewTotalClientes($this){
    var html = "<a href=\"#\" data-route=\"{{ route('analise_atrasos_equipe.modal.cliente') }}\" data-abertura='total' data-abertura-geral='true' data-cliente='false' data-busca='' data-total='true' data-filter=\""+$this.filter+"\" data-title='TITULOS FATURADOS POR CLIENTE - TOTAL - TODOS' class='bt-view bt-titulos-total-clientes'></a>"
    return html;
}

function createBtViewTotalRepresentantes($this){
    var html = "<a href=\"#\" data-route=\"{{ route('analise_atrasos_equipe.modal.representantes') }}\" data-filter=\""+$this.filter+"\" data-title='TITULOS FATURADOS POR Representante - TOTAL - TODOS' data-abertura='total' data-total='true' data-representante='false' data-cliente='null' class='bt-view bt-titulos-total-representantes'></a>"
    return html;
}
...
function filter(){
    ...
    @endif
    $.ajax({
        url: "{{ route('analise_atrasos_equipe.filter') }}",
        data: $data_form,
        method: 'POST',
        success: function(callback){
            if(callback.status == 'sucess'){
                ...
                if(linhas){
                    ...
                    $(table_filters_atrasos.column(4).footer()).html((callback.response.total.total) ? createBtViewTotalClientes(callback.response.total) : '');
                    @if(Auth::user()->tipo_usuario_id != "16" && Auth::user()->tipo_usuario_id != "12")
                    $(table_filters_atrasos.column(5).footer()).html((callback.response.total.total) ? createBtViewTotalRepresentantes(callback.response.total) : '');
                    @endif
