...
<div class="content-dialog-table">
    <div class="content-table">
        <table class="table table-striped table-not-edit table-not-view" id="table-modal-abertura-inadimplencia">
            <thead>
                <tr>
                    <th>Banco</th>
...
$(document).ready( function () {
    ...
    table_abertura_inadimjplencia = $('#table-modal-abertura-inadimplencia')
    ...
    table_abertura_inadimjplencia.draw();
});
</script>
@endsection  