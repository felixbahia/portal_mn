...
<div class="content-dialog-table">
    <div class="content-table">
        <table class="table table-striped table-not-edit table-not-view" id="table-modal-abertura-cancelados">
            <thead>
                <tr>
                    <th>Banco</th>
...
$(document).ready( function () {
    table_filters_analitic_abertura_cancelados = $('#table-modal-abertura-cancelados')
    ...
    table_filters_analitic_abertura_cancelados.draw();
});
</script>
@endsection  