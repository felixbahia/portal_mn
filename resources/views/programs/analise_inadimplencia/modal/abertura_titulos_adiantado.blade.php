...
<div class="content-dialog-table">
    <div class="content-table">
        <table class="table table-striped table-not-edit table-not-view" id="table-modal-abertura-adiantados">
            <thead>
                <tr>
                    <th>Banco</th>
...
$(document).ready( function () {
    table_filters_analitic_abertura_titulos_adiantados = $('#table-modal-abertura-adiantados')
    ...
    table_filters_analitic_abertura_titulos_adiantados.draw();
});
</script>
@endsection  