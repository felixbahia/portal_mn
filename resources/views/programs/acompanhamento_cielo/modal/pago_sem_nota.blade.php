				...
				<table class="table table-striped table-filter-pedido-itens table-not-edit" id="table-filters-acompanhamento_pedido">
					...
					<tbody>
						...
						<tr>
							...
							<td><div><div data-toggle="tooltip" data-html="true" title="" data-placement="left" data-original-title="{{ $pedido["status"] }}">{{ $pedido['status'] }}</div></div></td>
							...
							<td>
								@if($pedido['status'] == 'Cancelado' && $pedido['presencial'] == 'não' && $pedido['estorno'] == false && !empty($pedido['id_cielo']))
									<i data-toggle="tooltip" onclick="abrirEstorno('{{ $pedido['id_cielo'] }}')" data-html="true" title="" data-original-title="Realizar Estorno" data-placement="left" class="bt-estorno"></i>
                                @elseif($pedido['estorno'] == true)
                                    <a href="#" class="bt-view" data-toggle="tooltip" data-placement="left" data-html="true" title="" onclick="listarEstornos('{{ $pedido['id_cielo'] }}')" data-original-title="Visualizar Estornos"></a>
								@endif
							</td>
...
<script>
    ...
    function listarEstornos($id){
        $.ajax({
            url: "{{ route("acompanhamento_cielo.modal.listar_estornos") }}",
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}",
                pedido_id: $id
