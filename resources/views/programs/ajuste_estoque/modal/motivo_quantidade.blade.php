    ...
    <table class="table table-striped" id="table-dialog">
        <thead>
            <tr>
                ...
                <th class="tb_number">Quantidade Total</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($dados as $ajuste_estoque)
             <tr>
                ...
                <td class="tb_number">{{ $ajuste_estoque['quantidade_positiva'] }}</td>
                <td class="tb_number">{{ $ajuste_estoque['quantidade_negativa'] }}</td>
        ...
        <tfoot>
            <tr>
                <td>Total:</td>
                <td class="tb_number">{{ $total['quantidade_positiva'] }}</td>
                <td class="tb_number">{{ $total['quantidade_negativa'] }}</td>
    ...
    function abrirAjustes($filtros){
        $.ajax({
            ...
            success: function(data){
                $id = "view-pedido";
                $title = "Detalhes do Ajuste por quantidade"; 
                $body = data;
                $class = "modal-lg";
