    ...
    <table class="table table-striped table-filter-dialog footer-pequeno" id="table-filters-dialog_titulos">
        ...
        <tbody>
            ...
            <tr>
                ...
                @endif
                <td><div><div data-toggle="tooltip" data-html="true" title="{!! $value["numero"] !!}">{!! $value["numero"] !!}</div></div></td>
                <td>{{ $value["parcela"] }}</td>
                ...
                <td>
                @if(isset($value['observacao']))
                    <div><div data-toggle="tooltip" data-html="true" title="{{ $value["observacao"] }}">{{ $value["observacao"] }}</div></div>
                @endif
                </td>
            </tr>
            @endforeach
...
$(document).ready(function(){
    ...
    table_filters_dialog_titulos = [];
    table_filters_dialog_titulos = $('#table-filters-dialog_titulos')
        ...
        buttons: [
            {
                extend: 'excelHtml5',
                text: ' ',
                title: 'Títulos/Cheque por Banco',
                footer: true,
