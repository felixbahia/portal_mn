    ...
    <div class="content-table">
        <table class="table table-striped table-filter-dialog footer-pequeno" id="table-clientes-atrasos">
            ...
            <tbody>
                @foreach ($retorno as $dado)
                    <tr>
                        ...
                        <td>
                            <a href="#" class="modal-titulos-cliente-aberto" data-route="{{ route('duplicatas_cheque_banco.modal.titulos') }}" data-cliente='true' data-abertura-geral='{{ $aberturageral }}' data-abertura='aberto' data-total='false' data-busca='{{ $dado["cliente"] }}' data-title-modal="{{  ($aberturageral == 'false') ? $dado['banco'] : 'TODOS' }} - TITULOS FATURADOS VENCIDOS -  {{  $dado['cliente']   }}" data-filter="{{ $dado['filter'] }}" >{{ $dado['aberto'] }}</a>
                        </td>
                        <td>
                            <a href="#" class="modal-titulos-cliente-vencido" data-route="{{ route('duplicatas_cheque_banco.modal.titulos') }}" data-cliente='true' data-abertura-geral='{{ $aberturageral }}' data-abertura='vencido' data-total='false' data-busca='{{ $dado["cliente"] }}' data-title-modal="{{  ($aberturageral == 'false') ? $dado['banco'] : 'TODOS' }} - TITULOS FATURADOS VENCIDOS -  {{  $dado['cliente']   }}" data-filter="{{ $dado['filter'] }}" >{{ $dado['vencido'] }}</a>
                        </td>
                        <td>
                            <a href="#" class="modal-titulos-cliente-total" data-route="{{ route('duplicatas_cheque_banco.modal.titulos') }}" data-cliente='true' data-abertura-geral='{{ $aberturageral }}' data-abertura='total' data-total='false' data-busca='{{ $dado["cliente"] }}' data-title-modal="{{  ($aberturageral == 'false') ? $dado['banco'] : 'TODOS' }} - TITULOS FATURADOS TOTAL -  {{  $dado['cliente']   }}" data-filter="{{ $dado['filter'] }}" >{{ $dado['total'] }}</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
                <td>Total</td>
                <td>
                    <a href="#" class="modal-titulos-cliente-aberto-total" data-route="{{ route('duplicatas_cheque_banco.modal.titulos') }}" data-cliente='true' data-abertura-geral='{{ $aberturageral }}' data-abertura='aberto' data-total='true' data-busca='' data-title-modal="TODOS - TITULOS FATURADOS ABERTOS" data-filter="{{ $dado['filter'] }}" >{{ $total['aberto'] }}</a>
                </td>
                <td>
                    <a href="#" class="modal-titulos-cliente-vencido-total" data-route="{{ route('duplicatas_cheque_banco.modal.titulos') }}" data-abertura='vencido' data-abertura-geral='{{ $aberturageral }}' data-cliente='true' data-total='true' data-busca='' data-title-modal="TODOS - TITULOS FATURADOS VENCIDOS" data-filter="{{ $dado['filter'] }}" >{{ $total['vencido'] }}</a>
                </td>
                <td>
                    <a href="#" class="modal-titulos-cliente-geral-total" data-route="{{ route('duplicatas_cheque_banco.modal.titulos') }}" data-cliente='true' data-abertura-geral='{{ $aberturageral }}' data-abertura='total' data-total='true' data-busca='' data-title-modal="TODOS - TITULOS FATURADOS TOTAL" data-filter="{{ $dado['filter'] }}" >{{ $total['total'] }}</a>
                </td>
            </tfoot>  
        </table>
    </div>
