...
<form action="#" name="form_filter" id="form_filter" onsubmit="return false;">
    ...
    <div class="content-fields">
        {!! Form::hidden('tipo', 'comercial', ['id' => 'tipo']) !!}
        <div class="col-sm-2">   
...
@section('script-footer')
    ...
    function buscarNotas(){
        ...
        $.ajax({
            url: '{{ route("devolucao_nota_aprovacao.gerente.filter") }}',
            dataType: 'json',
            method: 'POST',
            ...
            success: function(data){
                ...
                for(var field in response){
                    ...
                    titulo_linha = [
                        createBtnReprovar(response[field].id, response[field].mostrar_reprovacao, response[field].status),
                        ...
                        "<div><div data-toggle='tooltip' data-html='true' data-placement='right' title='"+response[field].status_exibir + "'>" + response[field].status_exibir + "</div></div>",
                        response[field].parado,
                        createBtnVisualizar(response[field].id),
                        createBtnAprovar(response[field].id, response[field].mostrar_aprovacao, response[field].status),
                        createBtnCancelar(response[field].id)
                    ]
    ...
    function createBtnAprovar($id, $mostrar_botoes, $status){
        ...
        if($mostrar_botoes === true && $status < 7){
