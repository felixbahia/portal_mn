...
<div class="content-dialog-table">
    <table class="table table-striped table-filter-dialog" id="table-filters-dialog_credito">
        <thead>
            <tr>
...
<script type="text/javascript">
    table_filters_dialog_credito = $('#table-filters-dialog_credito').DataTable({
        "searching": false,
        "lengthChange": false,
        "info": false,
        "pageLength": 20,
