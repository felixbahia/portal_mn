...
<form action="{{ route('pedido.motivo_recusa.editar') }}" id="frm_edit_motivo" name="frm_edit_motivo" onsubmit="return false;">
    @csrf
    {!! Form::hidden('id', $dados['id']) !!}
    <div class="form-group">
        {{ Form::label('motivo', 'Motivo') }}
        {!! Form::textarea('motivo', $dados['motivo'], ['maxlength' => '250', 'rows' => '2', 'class' => 'form-control']) !!}
    </div>
