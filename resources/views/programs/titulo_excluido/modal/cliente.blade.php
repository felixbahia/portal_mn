    ...
    <div class="content-table">
        <table class="table table-striped table-filter-dialog footer-pequeno" id="table-clientes-atrasos">
            ...
            <tfoot>
                <td>Total</td>
                <td>
                    <a href="#" class="modal-titulos-cliente-geral-total" data-route="{{ route('titulo_excluido.modal.titulos') }}" data-cliente='true' data-abertura-geral='{{ $aberturageral }}' data-abertura='total' data-total='true' data-busca='' data-title-modal="TODOS - TITULOS FATURADOS TOTAL" data-filter="{{ $dado['filter'] }}" >{{ $total['total'] }}</a>
                </td>
            </tfoot>  
        </table>
    </div>
