    ...
    <div class="content-table">
        <table class="table table-striped table-filter-dialog footer-pequeno" id="table-clientes-atrasos">
            ...
            <tbody>
                @foreach ($retorno as $dado)
                    <tr>
                        ...
                        <td>
                            <a href="#" class="modal-titulos-total-representante" data-route="{{ route('titulo_excluido.modal.titulo.representantes') }}" data-abertura='total' data-total='{{ $saidatotal }}' data-representante='true' data-title-modal="{{  ($filter['total'] != 'true') ? $dado['estabelecimento'] : 'Todos' }} - TITULOS FATURADOS TOTAL -  {{  $dado['representante']   }}" data-titulo_id="{{ $dado['titulo_id'] }}" data-filter="{{ $dado['filter'] }}" >{{ $dado['total'] }}</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
                <td>Total</td>
                <td>
                    <a href="#" class="modal-titulos-geral-representante-total" data-route="{{ route('titulo_excluido.modal.titulo.representantes') }}" data-abertura='total' data-total='{{ $saidatotal }}' data-representante='false' data-title-modal="TODOS - TITULOS FATURADOS TOTAL - TODOS" data-titulo_id="" data-filter="{{ $total['filter'] }}">{{ $total['total'] }}</a>
                </td>
            </tfoot>  
        </table>
    </div>
