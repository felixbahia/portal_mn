        ...
        <div class="content-dialog-table">
            <table class="table table-striped table-not-edit table-not-view" id="table-vendedores">
                <thead>
                    <tr>
                        <th>Vendedor</th>
                        <th class="tb_number_150">Titulos Pago</th>
                        <th class="tb_number_150">% Comissão</th>
                        <th class="tb_number_150">Valor Comissão</th>
                    ...
                    @foreach($vendedores as $unidade_negocio)
                        @foreach($unidade_negocio as $vendedor)
                            <tr>
                                ...
                                <td>{{ $vendedor['valor_titulo_pago'] }}</td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="tb_number_150">{{ $total_titulo_pago }}</td>
                        <td></td>
