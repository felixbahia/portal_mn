...
<div class="content-filter-dialog">
    <form action="#" name="form_filter_dialog_teste" id="form_filter_dialog_teste" onsubmit="return false;">
        @csrf
        <input type="hidden" name="estabelecimento" value="{{ $estabelecimento }}">
        <input type="hidden" name="cliente_uf" value="{{ $cliente_uf }}">
        <input type="hidden" name="origem" value="{{ $origem }}">
        <input type="hidden" name="redespacho" value="{{ $redespacho }}">
        <div class="content-fields">
            ...
            <div class="col-lg-2">
                <input type="text" name="cnpj_filtro_transportadora" id="cnpj_filtro_transportadora" value="" placeholder="CNPJ" maxlength="250" />
            </div>
            <div class="col-lg-3">
...
<script>
    ...
    $(document).ready( function () {
        $("#form_filter_dialog_teste").find("#btn-filterform").on("click", function(){
            filterAjaxDialog($("#form_filter_dialog_teste").serialize());
        });
    ...
    function filterAjaxDialog(data_form){
        ...
        $.ajax({
            url: "{{ route('transportadora_estabelecimento.filtro_modal_dialog') }}",
            dataType: 'json',
            data: data_form,
            method: 'POST',
