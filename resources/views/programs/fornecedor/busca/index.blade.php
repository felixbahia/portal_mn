...
<div class="content-dialog-table">
        <table class="table table-striped table-filter-dialog" id="table-filters-dialog-fornecedor">
            <thead>
                <tr>
                    <th>Código</th>
...
<script>
    ...
    $(document).ready( function () {
        ...
        $('#table-filters-dialog-fornecedor').find("td").off('mouseenter');
        $('#table-filters-dialog-fornecedor').find("td").on('mouseenter', function(){
            var $this = $(this);
        ...
        table_dialog = $("#table-filters-dialog-fornecedor").DataTable({
            "searching": false,
            "lengthChange": false,
            "info": false,
            "pageLength": 10,
            "language": {
                ...
                "columnDefs": [
                    {
                        "targets": ($('#table-filters-dialog-fornecedor thead th').length - 1),
                        "orderable": false
                    },
                ],
                "paginate": {
    ...
    function filterAjaxDialog(data_form){
        ...
        $.ajax({
            url: "{{ route('fornecedor.busca.filter') }}",
            dataType: 'json',
            data: data_form,
            method: 'POST',
