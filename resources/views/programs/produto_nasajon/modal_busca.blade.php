...
<script>
	...
	$(document).ready(function() {
		$(document).find('#form_filter_produtos').find("#marca_modal_busca").autocomplete(optionsAutoCompleteMarca());
		$(document).find('#form_filter_produtos').find("#linha_modal_busca").autocomplete(optionsAutoCompleteLinha());
		$(document).find('#form_filter_produtos').find("#grupo_modal_busca").autocomplete(optionsAutoCompleteGrupo());
		$(document).find('#form_filter_produtos').find("#nome_modal_busca").autocomplete(optionsAutoCompleteProdutoNasajon());
