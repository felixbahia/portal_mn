...
<form action="#" id="frm_edit_motivo" name="frm_edit_motivo" onsubmit="return false;">
    @csrf
    {!! Form::hidden('id', $dados['id']) !!}
    <div class="form-group">
        {{ Form::label('motivo', 'Motivo') }}
        {!! Form::textarea('motivo', $dados['motivo'], ['maxlength' => '250', 'rows' => '1', 'class' => 'form-control']) !!}
    </div>
    <div class="form-check">
        {!! Form::checkbox('observacao', 'true', $dados['observacao'], ['class' => 'form-check-input', 'id' => 'observacao']) !!}
...
<script type="text/javascript">
	$(function(){
        ...
        $(document).find('#frm_edit_motivo').find("#bt_salvar").on('click', function(event){
            ...
            $.ajax({
                url: '{{ route("retornos_cobrancas.editar")}}',
                dataType: 'json',
                data: form.serialize(),
                method: 'POST',
