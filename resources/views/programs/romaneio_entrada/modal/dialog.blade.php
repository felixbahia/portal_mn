    ...
    <table class="table table-striped table-not-edit table-not-view"  id="table-dialog">
        <thead>
            <tr>
                ...
                <th  class="tb_number" rowspan="2">Total R$</th>
        ...
        <tbody>
            ...
            @foreach ($dados as $romaneio)
             <tr>
              ...
              <td class="tb_number">{{ $romaneio['produto_preco'] }}</td>
              <td>{{ $romaneio['peca_codigo'] }}</td>
                ...
                <td class="tb_number">{{ $romaneio['total_item'] }}</td>
        ...
        <tfoot>
            <tr>
                ...
                <td class="tb_number" id='total_diferenca_valor'> {{ $totais['total_diferenca_valor'] }}</td>
