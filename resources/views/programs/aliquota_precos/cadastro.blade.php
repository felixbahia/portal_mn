...
<div class="container">
	...
	<form action="{{ route("aliquota_preco.cadastro") }}" method="post" id="cadMargem" name="cadMargem" onsubmit="return false">
	    ...
	    <div class="form-row">
	    	<div class="col-md-8">
			    ...
			    <div class="row">
			    	<div class="col-md-6">
				        ...
				        {{ Form::text('frete_adicional', '', array('id' => 'frete_adicional_modal', 'class' => 'form-control')) }}
				    </div>
				...
				<div class='row'>
			    	<div class="col-md-6">
				        ...
				        {{ Form::text('icms_venda', '', array('id' => 'icms_venda', 'class' => 'form-control')) }}
				    </div>
			    	<div class="col-md-6">
				        {{ Form::label('icms_venda_cliente_isento', 'Cliente Isento') }}
				        {{ Form::text('icms_venda_cliente_isento', '', array('id' => 'icms_venda_cliente_isento', 'class' => 'form-control')) }}
				    </div>
			    </div>
	    	...
	    	<div class="col-md-3 ml-4 mt-3">
		        {{ Form::checkbox('internacional', '1', '', array('id' => 'internacional', 'class' => 'form-check-input')) }}
		        {{ Form::label('internacional', 'Aliquota para importados?', array('class' => 'form-check-label')) }}
		    </div>
	    </div>
