...
<div class="content-dialog-table">
        <div class="content-table">
            <table class="table table-striped table-not-edit table-not-view" id="table-filters-compras">
                <thead>
                    <tr>
                ...
                <tfoot>
                    ...
                    <td></td>
                    <td>Total</td>
                    <td class='text-right'>{{ parserValor($totalCompras) }}</td>
                </tfoot> 
            </table>
        </div>
</div>
...
setTimeout(function(){
    ...
    var table_filters_analitic = $('#table-filters-compras')
