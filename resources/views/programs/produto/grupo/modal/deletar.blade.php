...
<div class="row">
	<div class="col-sm-12">
		<b>Deseja realmente excluir este grupo?</b>
	</div>
</div>
<br>
<div class="row border-bottom">
	<div class='col-sm-6'><b>Grupo</b></div>
	<div class='col-sm-6'>{!! nl2br($dados['grupo']) !!}</div>
</div>
<br>
...
<div class="row">
	<div class="col-sm-12">
		<b>Há {{ $quantidade }} produto(s) com esse grupo. Não sendo possível excluir o grupo.</b>
	</div>
</div>
<br>
<div class="content-buttons float-right">
...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$(document).find("#btn-delete").on("click", function(event) {
			var $this = $(this);
			$.ajax({
				url: "{{ route('produto.grupo.deletar') }}",
				dataType: 'json',
				...
				success: function(callback){
					if(callback.status === "success"){
						...
						message("Atenção", "Grupo excluido com sucesso!");
					} else {
