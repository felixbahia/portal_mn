...
@section('content')
<form action="" name="form_tecido_estampado_add" id="form_tecido_estampado_add" onsubmit="return false;">
    @csrf
    <div class="form-row">
        <div class="form-group col-sm-12">
            {{ Form::label('codigo_produto_final', 'Codigo Tecido Estampado', []) }} 
            <div class="input-group" id="cod_produto_group">
                {{ Form::text('codigo_produto_final', '', ['id' => 'codigo_produto_final', 'class' => 'form-control', 'placeholder' => 'Codigo Tecido Estampado', 'maxlength' => '60']) }}
    ...
    <div class="form-row">
        <div class="form-group col-sm-12"> 
            ...
            {{ Form::text('descricao_final', '', ['id' => 'descricao_final', 'class' => 'form-control', 'placeholder' => 'Descrição Tecido Estampado', 'maxlength' => '120']) }}
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-sm-4">
            ...
            <div class="input-group" id="cod_produto_group">
                {{ Form::text('codigo_produto_tecido_base', '', ['id' => 'codigo_produto_tecido_base', 'class' => 'form-control', 'placeholder' => 'Codigo Tecido Base', 'maxlength' => '60']) }}
        ...
        <div class="form-group col-sm-8"> 
            ...
            {{ Form::text('descricao_tecido_base', '', ['id' => 'descricao_tecido_base', 'class' => 'form-control', 'placeholder' => 'Descrição Tecido Base', 'maxlength' => '120']) }}
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-sm-4">
            ...
            <div class="input-group" id="cod_produto_group">
                {{ Form::text('codigo_produto_desenho', '', ['id' => 'codigo_produto_desenho', 'class' => 'form-control', 'placeholder' => 'Codigo Desenho', 'maxlength' => '60']) }}
        ...
        <div class="form-group col-sm-8"> 
            ...
            {{ Form::text('descricao_desenho', '', ['id' => 'descricao_desenho', 'class' => 'form-control', 'placeholder' => 'Descrição Desenho', 'maxlength' => '120']) }}
        </div>
    </div>
...
<script>
    $(document).ready( function () {
        form_modal = $(document).find('#form_tecido_estampado_add');
    ...
    function inserirDados(data_form_modal){
        $.ajax({
            url: "{{ route('produto.tecido_estampado.adicionar') }}", 
            dataType: 'json',
    ...
    function limparMesagemErroModal(){      
        var form_modal = $("#form_tecido_estampado_add");
