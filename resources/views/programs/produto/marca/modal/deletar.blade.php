...
<div class="row">
	<div class="col-sm-12">
		<b>Deseja realmente excluir este marca?</b>
	</div>
</div>
<br>
<div class="row border-bottom">
	<div class='col-sm-6'><b>Marca</b></div>
	<div class='col-sm-6'>{!! nl2br($dados['marca']) !!}</div>
</div>
<br>
...
<div class="row">
	<div class="col-sm-12">
		<b>Há {{ $quantidade }} produto(s) com essa marca. Não sendo possível excluir a marca.</b>
	</div>
</div>
<br>
<div class="content-buttons float-right">
...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$(document).find("#btn-delete").on("click", function(event) {
			var $this = $(this);
			$.ajax({
				url: "{{ route('produto.marca.deletar') }}",
				dataType: 'json',
				...
				success: function(callback){
					if(callback.status === "success"){
						...
						message("Atenção", "Marca excluido com sucesso!");
					} else {
