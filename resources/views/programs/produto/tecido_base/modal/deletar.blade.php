...
<div class="row">
	<div class="col-sm-12">
		<b>Deseja realmente excluir este Tecido Base?</b>
	</div>
</div>
<br>
<div class="row border-bottom">
	<div class='col-sm-6'><b>Código Produto</b></div>
	<div class='col-sm-6'>{!! nl2br($dados['codigo_produto']) !!}</div>
</div>
<div class="row border-bottom">
	<div class='col-sm-6'><b>Descrição</b></div>
	<div class='col-sm-6'>{!! nl2br($dados['descricao']) !!}</div>
</div>
<div class="row border-bottom">
	<div class='col-sm-6'><b>Prefixo Produto Novo</b></div>
	<div class='col-sm-6'>{!! nl2br($dados['codigo_produto_base']) !!}</div>
</div>
<br>
...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$(document).find("#btn-delete").on("click", function(event) {
			var $this = $(this);
			$.ajax({
				url: "{{ route('produto.tecido_base.deletar') }}",
				dataType: 'json',
