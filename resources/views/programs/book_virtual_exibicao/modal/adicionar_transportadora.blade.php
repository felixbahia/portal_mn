...
@section('content')
<form id="form_add_transportadora" name="form_add_transportadora">
    @csrf
    <div class="form-row">
        <div class="col-sm">
            ...
            <div class="input-group">
                {{ Form::text('transportadora_nome', '', ['id' => 'transportadora_nome', 'class' => 'form-control input-label']) }}
            ...
            <div class="input-group">
                {{ Form::text('transportadora_redespacho_nome', '', ['id' => 'transportadora_redespacho_nome', 'class' => 'form-control input-label']) }}
                {{ Form::hidden('transportadora_resdespacho_codigo', '', ['id' => 'transportadora_resdespacho_codigo', 'class' => 'form-control']) }}
    ...
    <div class="form-row float-right mt-3">
        {{ Form::button('Adicionar', ['id' => 'bt-carrinho-adicionar', 'class' => 'btn btn-success']) }}
    </div>
</form>
...
<script>
    $(document).ready( function(){
        ...
        $(document).find("#bt-carrinho-adicionar").off('click');
            $(document).find("#bt-carrinho-adicionar").on('click', function(){
                event.stopPropagation();
                adicionarCarrinho(elementos, $quantidade, $preco, $(document).find("#transportadora_codigo").val(), $(document).find("#transportadora_resdespacho_codigo").val());
            });
    });
        ...
        return {
           ...
           delay: 700,
            ...
            open: function( event, ui ){
                $('.ui-autocomplete').css("z-index", (parseInt($('#modal_adicionar_transportadora').css('z-index')) + 1));
            },
