...
<div class="content-dialog-table">
    <div class="content-table">
        <table class="order-column table-striped" id="table-analise-vendas-linha">
            <thead>
                <tr>
                    <th rowspan="3">Linha</th>
                </tr>
                <tr>
                ...
                <tr>
                    @foreach($head as $heads)
                        ...
                        <th class="tb_number">% VALOR TOTAL<a href="#" class="btn-informacao-sem-width" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cálculo: Valor Total da Linha / Valor Total Geral das Linhas"></a> </th>
                    @endforeach
                </tr>
            </thead>
            <tbody>
...
$(document).ready( function () {
    var table_linha = $('#table-analise-vendas-linha').DataTable({
        "scrollX": false,
        "searching": false,
        "lengthChange": false,
        "searching": false,
