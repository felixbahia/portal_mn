...
<div class="content-dialog-table">
    <div class="content-table">
        <table class="order-column table-striped" id="table-analise-vendas-marca">
            <thead>
                <tr>
                ...
                <tr>
                    @foreach($head as $heads)
                        ...
                        <th class="tb_number">%VALOR TOTAL<a href="#" class="btn-informacao-sem-width" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cálculo: Valor Total da Marca / Valor Total Geral das Marcas"></a> </th>
                    @endforeach
                </tr>
            </thead>
            <tbody>
...
$(document).ready( function () {
    var table_grupo = $('#table-analise-vendas-marca').DataTable({
        "scrollX": false,
        "searching": false,
        "lengthChange": false,
        "searching": false,
