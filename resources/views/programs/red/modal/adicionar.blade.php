...
<form action="" name="form_despesa_planejada" id="form_despesa_planejada" onsubmit="return false;">
    ...
    <div class="form-row">
        <div class="form-group col-sm-12"> 
            ...
            {{ Form::text('documento', '', ['id' => 'documento', 'class' => 'form-control', 'placeholder' => 'Documento']) }}
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-sm-12">
            {{ Form::label('valor', 'Valor U$', []) }}
            {!! Form::text('valor', '', ['id' => 'valor', 'class' => 'form-control moeda text-right', 'placeholder' => 'Valor U$']) !!}
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-sm-12">
            {{ Form::label('taxa_cambio', 'Taxa Câmbio R$', []) }}
            {!! Form::text('taxa_cambio', '', ['id' => 'taxa_cambio', 'class' => 'form-control decimal_quatro_casas text-right', 'placeholder' => 'Taxa Câmbio R$']) !!}
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-sm-12"> 
            {{ Form::label('vencimento', 'Vencimento', []) }}
            {{ Form::text('vencimento', '', ['id' => 'vencimento', 'class' => 'form-control data', 'placeholder' => 'Vencimento']) }}
        </div>
    </div>
