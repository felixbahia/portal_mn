...
<div class="content-dialog-table">
    <div class="content-table">
        <table class="table table-striped table-filter-devolucoes" id="table-filters-separador">
            <thead>
                <tr>
                    <th>Separador</th>
            ...
            @foreach ($retorno as $linha)
                <tr>
                    <td>{{ $linha['aprovador_nome'] }}</td>
                    <td class='tb_number'>{{ $linha['quantidade'] }}</td>
                    <td class='tb_number'>{{ $linha['valor'] }}</td>
                    <td>
                        <a href="#" class="bt-view" data-status="{{ $linha['status'] }}" data-status-descricao="{{ $linha['status_descricao'] }}" data-hash="{{ $linha['hash'] }}" data-toggle="tooltip" data-placement="top" title="Por processos" onclick="showModalRepresentante(this)"></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
...
<script>
    ...
    $(document).ready(function(){
        table_filters_separador.draw();
    });

    table_filters_separador_options = {
        "searching": false,
        "lengthChange": false,
        "info": false,
        "paging": true,
    ...
    table_filters_separador = $('#table-filters-separador').DataTable(table_filters_separador_options);
