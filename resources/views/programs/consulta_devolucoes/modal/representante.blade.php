...
<div class="content-dialog-table">
    <div class="content-table">
        <table class="table table-striped table-filter-devolucoes" id="table-filters-representante">
            <thead>
                <tr>
                    <th>Vendedor</th>
...
<script>
    ...
    $(document).ready(function(){
        table_filters_representante.draw();
    });

    table_filters_representante_options = {
        "searching": false,
        "lengthChange": false,
        "info": false,
        "paging": true,
    ...
    table_filters_representante = $('#table-filters-representante').DataTable(table_filters_representante_options);
