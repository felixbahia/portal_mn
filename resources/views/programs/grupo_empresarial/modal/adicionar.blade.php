    ...
    <div class="participantes">
        <div class="form-row mt-2">
            <div class="input-group col-sm-12">
                {{ Form::text('nome_participante[]', '', ['class' => 'form-control nome_participantes']) }}
                {{ Form::text('participantes[]', '', ['class' => 'form-control raiz_cnpj participantes', 'placeholder' => '00.000.000', 'readonly']) }}
...
<script>
    ...
    function cadastrarForm(event){
        ...
        $.ajax({
            url: '{{ route("grupo_empresarial.adicionar") }}',
            dataType: 'json',
            data: form_data,
            method: 'POST',
    ...
    function optionsAutoCompleteCliente(){
        ...
        return {
            ...
            open: function( event, ui ){
                $('.ui-autocomplete').css("z-index", (parseInt($('#modal_grupo_empresarial').css('z-index')) + 1));
            },
    ...
    function optionsAutoCompleteParticipante(){
        ...
        return {
            ...
            select: function( event, ui ) {
                ...
                var raiz_cnpj = transformCNPJCliente(ui.item.cpf_cnpj);
                var ja_digitados = $(document).find(".raiz_cnpj").map(function (){ return $(this).val()});
