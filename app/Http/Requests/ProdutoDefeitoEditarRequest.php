...
class ProdutoDefeitoEditarRequest extends FormRequest
{
   /**
        ...
        return [
            'descricao' => [
                ...
                function($attribute, $value, $fail){  
                    $id = decrypt($this->id);
                    $ProdutoDefeito = ProdutoDefeito::where('descricao', 'ilike', $this->descricao)
                    ->where('id', '!=', $id)
                    ->exists();
                    if($ProdutoDefeito === true){
            ...
            'id' => [
                ...
                function($attribute, $value, $fail){  
                    $id = decrypt($this->id);
                    $ProdutoDefeito = ProdutoDefeito::where('id', $id)->exists();
                    if($ProdutoDefeito === false){
