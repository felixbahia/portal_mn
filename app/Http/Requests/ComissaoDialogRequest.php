...
class ComissaoDialogRequest extends FormRequest
{
    /**
    ...
    public function rules() {
        return [
            ...
            'representante' => 'required|exists:users,id',
        ];
    }
    ...
    public function messages() {
        return [
            ...
            'representante.exists' => __('validation.exists', ['attribute' => 'Representante']),
        ];
    }
