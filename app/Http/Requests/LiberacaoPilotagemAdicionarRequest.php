...
class LiberacaoPilotagemAdicionarRequest extends FormRequest
{
    /**
        ...
        return [
            ...
            'valor_credito' => [
                function($attribute, $value, $fail) {
                    if($this->abonar_pilotagem_alterar_comissao == 'abonar_pilotagem'){
            ...
            'nova_comissao' => [
                function($attribute, $value, $fail) {
                    if($this->abonar_pilotagem_alterar_comissao == 'alterar_comissao'){
            ...
            'validar_registro_comissao' => [
                'required_if:abonar_pilotagem_alterar_comissao,alterar_comissao',
            ],
            'validar_registro_pilotagem' => [
                'required_if:abonar_pilotagem_alterar_comissao,abonar_pilotagem',
            ]
        ];
    }
