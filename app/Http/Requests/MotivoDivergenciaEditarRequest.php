...
class MotivoDivergenciaEditarRequest extends FormRequest
{
        ...
        return [
            'descricao' => [
                ...
                function($attribute, $value, $fail){  
                    $id = decrypt($this->id);
                    $MotivoDivergencia = MotivoDivergencia::where('descricao', 'ilike', $this->descricao)
                    ->where('id', '!=', $id)
                    ->exists();
                    if($MotivoDivergencia === true){
            ...
            'id' => [
                ...
                function($attribute, $value, $fail){  
                    $id = decrypt($this->id);
                    $MotivoDivergencia = MotivoDivergencia::where('id', $id)->exists();
                    if($MotivoDivergencia === false){
