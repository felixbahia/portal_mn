...
class SazonalidadeEditarRequest extends FormRequest
{
      /**
        ...
        return [
            'descricao' => [
                ...
                function($attribute, $value, $fail){  
                    $id = decrypt($this->id);
                    $Sazonalidade = Sazonalidade::where('descricao', 'ilike', $this->descricao)
                    ->where('id', '!=', $id)
                    ->exists();
            ...
            'id' => [
                ...
                function($attribute, $value, $fail){  
                    $id = decrypt($this->id);
                    $Sazonalidade = Sazonalidade::where('id', $id)->exists();
