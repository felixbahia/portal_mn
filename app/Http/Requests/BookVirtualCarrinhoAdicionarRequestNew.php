...
class BookVirtualCarrinhoAdicionarRequestNew extends FormRequest
{
    /**
        ...
        return [
            ...
            'codigo_cliente' => [
                ...
                function($attribute, $value, $fail) use ($clienteObj, $PedidoPortal){
                    ...
                    if (!empty($clienteObj->suframa_codigo) && !in_array(intval($this->estabelecimento), [3, 4]) && $clienteObj->uf == 'AM'){
