...
class SegmentoSalvarEdicaoRequest extends FormRequest
{
    /**
            ...
            'imagem' => [
                function($attribute, $value, $fail) use ($id){
                    if(empty($this->imagem)){
                        $Segmentos = Segmento::where('id', $id)->whereNull('imagem')->exists();
                        if($Segmentos === true){
                            return $fail(__('validation.unique', ['attribute' => 'Imagem']));
                        }
                    }
                },
                'mimes:jpg,jpeg,png',
