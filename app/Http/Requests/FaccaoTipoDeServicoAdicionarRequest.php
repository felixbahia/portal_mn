...
class FaccaoTipoDeServicoAdicionarRequest extends FormRequest
{
    /**
            ...
            'faccao' => [
                ...
                function($attribute, $value, $fail){
                    if(!empty($this->codigo_faccao) && !empty($this->tipo_de_servico)){
                        ...
                        $query->where('codigo_faccao', $codigo_faccao );
                        $query->where('codigo_tipo_de_servico', $tipo_de_servico);
                        $result = $query->first();
                        if(!empty($result)){
