...
class AvisoDeChegadaProduto extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'aviso:chegada_produto';
     ...
     * @var string
     */
    protected $description = 'Aviso de chegada de embarque do produto';
    ...
    {
        $AtualizacaoCronObj = AtualizacaoCron::select()->where('token', 'aviso:chegada_produto')->first();
        ...
        if($inicio_atualizacao->lte($final_atualizacao)){
            ...
            try{
                $objeto = $bookVirtualExibicaoController->avisoDechegadaProduto();
