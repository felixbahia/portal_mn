...
use App\Http\Controllers\EstoquePoderTerceiroController;

class ImportacaoEstoqueTerceiroCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'importacao:estoque_terceiro';
     ...
     * @var string
     */
    protected $description = 'Importa todos estoque em poder de terceiros';
    ...
    public function handle()
    {
        ...
        if($inicio_atualizacao->lte($final_atualizacao)){
            ...
            $estoque_terceiro = new EstoquePoderTerceiroController();

            try{
                $objeto_estoque_terceiro = $estoque_terceiro->importarEstoqueTerceiro();
