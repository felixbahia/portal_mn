...
class ImportarCteEntradaCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'importar:cte {inicio_periodo=0} {fim_periodo=0}';
     ...
     * @var string
     */
    protected $description = 'Importar CTE de entrada pelo web service multinotas.';
    ...
    {
        $AtualizacaoCronObj = AtualizacaoCron::select()->where('token', 'importar:cte')->first();
        ...
        if($inicio_atualizacao->lte($final_atualizacao)){
            ...
            try{
                ...
                while($inicio_periodo->lte($fim_periodo)){
                    ...
                    $retorno->importarCte($inicio_periodo,$data_adicional);
                    $contador ++;
