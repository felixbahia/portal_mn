...
class MonitorarPedidosCampanhaCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'campanha:monitorar_pedidos';
     ...
     * @var string
     */
    protected $description = 'Monitorar pedidos da campanha para alimentar tabela de carga para comissão.';
    ...
    {
        $AtualizacaoCronObj = AtualizacaoCron::select()->where('token', 'campanha:monitorar_pedidos')->first();
        ...
        if($inicio_atualizacao->lte($final_atualizacao)){
            ...
            try{
                ...
                $campanhas_objetos->monitorarPedidosComissao();
                $campanhas_objetos->controleComissaoGerente();
