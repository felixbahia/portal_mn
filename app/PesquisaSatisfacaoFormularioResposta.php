...
class PesquisaSatisfacaoFormularioResposta extends Model
{
    use SoftDeletes;
    ...
    public function tipoRespostas(){
        return $this->hasOne('App\PesquisaSatisfacaoFormularioTipoResposta', 'id', 'pesquisa_satisfacao_clientes_id');
    }
