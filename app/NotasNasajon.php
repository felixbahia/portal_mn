...
class NotasNasajon extends Model
{
    use \Awobaz\Compoships\Compoships;
    
    protected $connection = 'nasajon';
    protected $table = 'integracoes.vw_nfes_saida';
    ...
    public function pesquisaSatisfacaoCliente(){
        return $this->setConnection('pgsql')->hasOne('App\PesquisaSatisfacaoCliente', 'documento', 'cliente_documento')->orderBy('created_at','desc');
    }

    public function pesquisaSatisfacaoNota(){
        return $this->setConnection('pgsql')->hasOne('App\PesquisaSatisfacaoClienteNota', 'nota_nasajon_id', 'id')->orderBy('created_at','desc');
    }

    public function titulosBaixados(){
        return $this->hasMany('App\ContasReceberBaixadoNasajon', 'documento_id', 'id');
    }

    public function campanhas(){
        return $this->setConnection('pgsql')->hasOne('App\CampanhasComissaoCalculo', 'nota_id', 'id');
    }
}
